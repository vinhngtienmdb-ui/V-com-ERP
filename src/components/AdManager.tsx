...
export function AdManager() {
 ...
 <div>
 <h3 className="text-xl font-bold text-[#111827]">Xu hướng Doanh thu Quảng cáo</h3>
 ...
 <p className="text-[10px] text-slate-500">Độ chính xác: Cao</p>
 </div>
 </div>
 ...
 <p className="text-[9px] font-bold text-emerald-500">Vượt chuẩn</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <h3 className="text-xl font-bold italic">Thuật toán Đấu giá Quảng cáo v3</h3>
 </div>
