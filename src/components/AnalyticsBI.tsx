...
export function AnalyticsBI() {
 ...
 <div className="w-1.5 h-1.5 bg-rose-500 rounded-full animate-ping" /> Security Node
 </span>
 </div>
 <div className="p-5">
 ...
 <div>
 <h3 className="text-lg font-black text-slate-900 tracking-tight">AI Fraud Detection Guardian</h3>
 </div>
 </div>
 ...
 <div className="w-2 h-2 bg-rose-500 rounded-full animate-pulse" /> Incident Detected
 </span>
