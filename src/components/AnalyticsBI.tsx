  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="header-title">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 bg-blue-50 px-2 py-0.5 rounded">Intelligence Hub</span>
            <div className="w-1 h-1 bg-blue-600 rounded-full animate-pulse" />
          </div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Business Intelligence</h1>
          <p className="text-sm text-slate-500 font-medium mt-1">Hệ thống phân tích chuyên sâu RFM, LTV, CAC và Giám sát gian lận thời gian thực.</p>
        </div>
        <div className="flex flex-wrap gap-3">
          ...
          <button className="bg-blue-600 text-white px-5 py-2.5 rounded-none text-xs font-black uppercase tracking-widest hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/20 flex items-center gap-2 hover:scale-[1.02] active:scale-95">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div key={stat.label} className={cn(
            "relative overflow-hidden p-6 rounded-none border transition-all duration-300 hover:shadow-xl group",
            stat.alert ? "bg-rose-50 border-rose-200 shadow-rose-200/20" : "bg-white border-slate-100 shadow-slate-200/50 hover:shadow-blue-500/10"
          )}>
            <div className="relative z-10 flex flex-col justify-between h-full">
              <div className="flex justify-between items-start mb-4">
                <span className={cn(
                  "text-[10px] font-black uppercase tracking-widest",
                  stat.alert ? "text-rose-600" : "text-slate-400"
                )}>{stat.label}</span>
                <div className={cn(
                  "p-2 rounded-xl border transition-transform group-hover:rotate-12",
                  stat.alert ? "bg-rose-100 border-rose-200 text-rose-600 animate-pulse" : "bg-slate-50 border-slate-100 text-slate-400 group-hover:bg-blue-50 group-hover:text-blue-600"
                )}>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className={cn(
                    ...
                    stat.alert ? "bg-rose-200 text-rose-800" : "bg-blue-100 text-blue-700"
                  )}>{stat.trend}</span>
            ...
            <div className={cn(
              ...
              stat.alert ? "bg-rose-500" : "bg-blue-500"
            )} />
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-none border border-slate-100 shadow-xl shadow-slate-200/40">
           <div className="flex items-center justify-between mb-8">
              <div>
                 <h3 className="text-lg font-black text-slate-900 flex items-center gap-3">
                    <Users className="w-5 h-5 text-blue-600" /> Phân tích RFM (Recency/Frequency/Monetary)
                 </h3>
                 <p className="text-xs text-slate-400 font-medium mt-1">Phân vị khách hàng dựa trên lịch sử mua sắm</p>
              </div>
              <select className="text-[10px] font-bold uppercase tracking-widest bg-slate-50 border border-slate-200 rounded-none px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500/20">
        ...
        <div className="bg-white p-8 rounded-none border border-slate-100 shadow-xl shadow-slate-200/40">
           <div className="flex items-center justify-between mb-8">
              <div>
                 ...
                 <p className="text-xs text-slate-400 font-medium mt-1">Dự báo chuyển động tài chính trong 6 tháng tới</p>
              </div>
              <div className="flex gap-4 p-1.5 bg-slate-50 rounded-xl">
                 <div className="flex items-center gap-2 px-2">
                    <div className="w-2 h-2 rounded-full bg-blue-600" />
                    <span className="text-[10px] font-black uppercase text-slate-500">CLV</span>
                 </div>
                 <div className="flex items-center gap-2 px-2">
                    <div className="w-2 h-2 rounded-full bg-emerald-500" />
                    <span className="text-[10px] font-black uppercase text-slate-500">AOV</span>
                 </div>
              </div>
           </div>
           <div className="h-[320px]">
      ...
      <div className="bg-slate-900 text-white p-10 rounded-none relative overflow-hidden shadow-2xl shadow-blue-900/20">
         ...
         <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-2 space-y-6">
               <div className="flex items-center gap-4">
                  <div className="p-4 bg-rose-600 rounded-none shadow-2xl shadow-rose-600/30 group hover:rotate-12 transition-transform duration-500">
               ...
               <div className="flex flex-wrap gap-4 pt-2">
                  <button className="px-6 py-3 bg-white text-slate-900 font-black rounded-none text-[11px] uppercase tracking-widest hover:bg-slate-100 transition-all shadow-xl shadow-white/10 hover:-translate-y-0.5">
                     Open Security Console
                  </button>
                  <button className="px-6 py-3 bg-white/10 backdrop-blur-md border border-white/10 text-white font-black rounded-none text-[11px] uppercase tracking-widest hover:bg-white/20 transition-all">
                     Configure AI Policy
                  </button>
               </div>
            </div>
            ...
            <div className="space-y-4">
               <div className="p-6 bg-white/5 backdrop-blur-2xl rounded-none border border-white/10 space-y-4 shadow-2xl">
                  <div className="flex justify-between items-center">
                     ...
                     <span className="text-[10px] text-slate-500 font-bold font-mono">2 min ago</span>
                  </div>
                  ...
                  <div className="pt-2 border-t border-white/5">
                     <button className="w-full py-2.5 bg-rose-600/20 hover:bg-rose-600 text-rose-400 hover:text-white rounded-none text-[10px] font-black uppercase tracking-widest transition-all border border-rose-500/30">
