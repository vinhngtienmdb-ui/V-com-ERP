...
export function CustomerService() {
 ...
 <div>
 <h5 className="text-xs font-bold text-slate-800 uppercase mb-3">Sao chép đoạn JavaScript</h5>
 <div className="relative">
...
<script src="https://cdn.vcomm.io/chat.js" async></script>`}
 ...
 <button className="absolute top-2 right-2 bg-slate-900/10 hover:bg-white/20 text-[#FAF9F5] rounded p-1.5 transition-all text-[10px] font-bold">Sao chép mã</button>
 </div>
