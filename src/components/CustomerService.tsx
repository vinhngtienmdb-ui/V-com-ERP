...
export function CustomerService() {
 ...
 className={cn("px-3 py-1.5 text-xs font-bold rounded-md flex items-center gap-1.5 transition-all", roleScope === 'seller' ? "bg-white text-emerald-700 shadow-sm" : "text-stone-500 hover:text-stone-700")}
 >
 ...
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Tiếp nhận mới (Mở)</p>
 <AlertCircle className="w-4 h-4 text-red-500" />
 </div>
 <p className="text-3xl font-bold text-stone-800 relative z-10">24</p>
 ...
 <div className="flex justify-between items-start relative z-10 mb-2">
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Thời gian P/hồi TB (SLA)</p>
 <Clock className="w-4 h-4 text-orange-600" />
 </div>
 <p className="text-3xl font-bold text-stone-800 relative z-10">14 <span className="text-sm font-medium text-stone-500">phút</span></p>
 ...
 <div className="flex justify-between items-start relative z-10 mb-2">
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Đánh giá chung (CSAT)</p>
 <Star className="w-4 h-4 text-yellow-500" />
 </div>
 <p className="text-3xl font-bold text-stone-800 relative z-10">4.8<span className="text-xl text-stone-400">/5</span></p>
 <div className="mt-2 text-[10px] text-emerald-500 font-medium">Rất xuất sắc</div>
 </div>

 <div className="bg-white p-5 rounded-lg border border-stone-800 shadow-sm relative overflow-hidden group">
 ...
 {/* Main Content Area */}
 <div className="bg-white rounded-lg border border-stone-200 shadow-sm overflow-hidden min-h-[600px] flex flex-col">
 {/* Navigation Tabs */}
 <div className="flex bg-stone-50 border-b border-stone-200 p-2 gap-2 overflow-x-auto hidden-scrollbar">
 <button 
 onClick={() => setActiveTab('tickets')}
 className={cn("px-4 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all shrink-0", activeTab === 'tickets' ? "bg-white text-orange-700 shadow-sm border border-stone-200" : "text-stone-500 hover:bg-stone-100")}
 >
 <Ticket className="w-4 h-4" /> Quản lý Tickets
 </button>
 <button 
 onClick={() => setActiveTab('campaigns')}
 className={cn("px-4 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all shrink-0", activeTab === 'campaigns' ? "bg-white text-emerald-600 shadow-sm border border-stone-200" : "text-stone-500 hover:bg-stone-100")}
 >
 <Mail className="w-4 h-4" /> Chiến dịch Chăm sóc (Loyalty)
 </button>
 <button 
 onClick={() => setActiveTab('feedback')}
 className={cn("px-4 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all shrink-0", activeTab === 'feedback' ? "bg-white text-purple-600 shadow-sm border border-stone-200" : "text-stone-500 hover:bg-stone-100")}
 >
 <Star className="w-4 h-4" /> Phản hồi & Đánh giá
 </button>
 <button 
 onClick={() => setActiveTab('chat')}
 className={cn("px-4 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all shrink-0", activeTab === 'chat' ? "bg-white text-orange-700 shadow-sm border border-stone-200" : "text-stone-500 hover:bg-stone-100")}
 >
 <MessageSquare className="w-4 h-4" /> Chat Đa kênh (FB/Zalo)
 </button>
 <button 
 onClick={() => setActiveTab('calls')}
 className={cn("px-4 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all shrink-0", activeTab === 'calls' ? "bg-white text-emerald-600 shadow-sm border border-stone-200" : "text-stone-500 hover:bg-stone-100")}
 >
 ...
 className={cn("px-4 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all shrink-0", activeTab === 'agents' ? "bg-white text-rose-600 shadow-sm border border-stone-200" : "text-stone-500 hover:bg-stone-100")}
 >
 <Users className="w-4 h-4" /> Đội ngũ & Extension
 </button>
 <button 
 onClick={() => setActiveTab('config')}
 className={cn("px-4 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-all shrink-0", activeTab === 'config' ? "bg-white text-stone-800 shadow-sm border border-stone-200" : "text-stone-500 hover:bg-stone-100")}
 >
 ...
 className="bg-stone-50 border border-stone-200 rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none w-72 focus:bg-white focus:ring-4 focus:ring-orange-600/10 transition-all font-medium"
 />
 </div>
 <button className="bg-white border border-stone-200 px-4 py-2 rounded-lg text-sm text-stone-600 flex items-center gap-2 font-bold hover:bg-stone-50">
 ...
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest leading-relaxed">Ticket ID & KH</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest leading-relaxed">Vấn đề / Tiêu đề</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center leading-relaxed">Trạng thái</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center leading-relaxed">Mức độ ưu tiên</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right leading-relaxed">Thời gian</th>
 </tr>
 </thead>
 ...
 className={cn("hover:bg-[#F2F0E9]/50 cursor-pointer transition-colors group", ticket.status === 'open' ? 'bg-white' : 'bg-stone-50/30')}
 >
 <td className="px-6 py-4">
 <p className="text-xs font-mono font-bold text-stone-600 mb-0.5">{ticket.id}</p>
 <p className="text-sm font-bold text-stone-800 group-hover:text-orange-700 transition-colors">{ticket.customerName}</p>
 </td>
 <td className="px-6 py-4">
 ...
 <div>
 <p className="text-sm font-bold text-stone-700">{ticket.subject}</p>
 <p className="text-[10px] text-stone-400 uppercase tracking-widest font-bold mt-0.5">{ticket.type}</p>
 </div>
 </div>
 </td>
 ...
 ticket.status === 'in_progress' ? "bg-amber-100 text-amber-700" : "bg-stone-200 text-stone-500"
 )}>
 ...
 ticket.priority === 'medium' ? "border-amber-200 text-amber-600 bg-amber-50" : "border-stone-200 text-stone-500 bg-white"
 )}>
 {ticket.priority}
 </span>
 </td>
 <td className="px-6 py-4 text-right">
 <p className="text-xs text-stone-600 font-medium">{ticket.createdAt}</p>
 </td>
 </tr>
 ))}
 </tbody>
 ...
 <thead>
 <tr className="bg-stone-50/50 border-b border-stone-100">
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest leading-relaxed">Tên Chiến dịch</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest leading-relaxed">Kênh / Đối tượng</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center leading-relaxed">Đã gửi</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center leading-relaxed">Tỷ lệ Mở (Open Rate)</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right leading-relaxed">Trạng thái</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-stone-100">
 ...
 <td className="px-6 py-4">
 <p className="text-sm font-bold text-stone-800">{camp.name}</p>
 <p className="text-[10px] text-stone-400 font-mono font-bold mt-0.5">{camp.id}</p>
 </td>
 <td className="px-6 py-4">
 <p className="text-xs font-bold uppercase tracking-widest text-orange-700 mb-0.5">{camp.type}</p>
 <p className="text-xs text-stone-500">{camp.target}</p>
 </td>
 ...
 <span className="text-[10px] font-bold text-stone-500">{camp.openRate}%</span>
 </div>
 </td>
 <td className="px-6 py-4 text-right">
 <span className={cn(
 "px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest inline-block",
 camp.status === 'active' ? "bg-emerald-100 text-emerald-700" : "bg-stone-200 text-stone-500"
 )}>
 ...
 <div key={fb.id} className="p-5 border border-stone-200 rounded-lg shadow-sm bg-white hover:shadow-sm transition-shadow">
 <div className="flex justify-between items-start mb-3">
 <div className="flex items-center gap-2">
 <div className="w-8 h-8 rounded-full bg-white text-[#FAF9F5] font-bold flex items-center justify-center text-xs">
 {fb.customerName.charAt(0)}
 </div>
 <div>
 <p className="text-sm font-bold text-stone-800">{fb.customerName}</p>
 <p className="text-[10px] text-stone-400 capitalize">{fb.channel}</p>
 </div>
 </div>
 <span className="text-[10px] font-medium text-stone-400">{fb.date}</span>
 </div>
 <div className="flex gap-1 mb-2">
 {[...Array(5)].map((_, i) => (
 <Star key={i} className={cn("w-3 h-3", i < fb.rating ? "fill-yellow-400 text-yellow-400" : "text-stone-200")} />
 ))}
 </div>
 <p className="text-sm text-stone-600 italic">"{fb.comment}"</p>
 </div>
 ))}
 </div>
 )}
 ...
 {/* Sidebar - Thread List */}
 <div className="w-[320px] border-r border-[#F3F4F6] flex flex-col bg-stone-50/50">
 <div className="p-4 border-b border-[#F3F4F6]">
 <h2 className="text-sm font-bold text-[#111827] flex items-center gap-2 mb-3">
 Kênh tương tác (API)
 </h2>
 <div className="flex gap-2">
 <button className="flex-1 bg-stone-900 text-[#FAF9F5] text-[10px] font-bold py-1.5 rounded-lg flex justify-center items-center gap-1 shadow-sm"><span className="w-3 h-3 flex items-center justify-center rounded-full bg-white text-orange-700">f</span> Fanpage</button>
 <button className="flex-1 bg-stone-800 text-[#FAF9F5] text-[10px] font-bold py-1.5 rounded-lg flex justify-center items-center gap-1 shadow-sm"><MessageSquare className="w-3 h-3" /> Zalo OA</button>
 </div>
 ...
 className="w-full bg-white border border-[#E5E7EB] rounded-lg pl-10 pr-4 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-orange-600 transition-all shadow-sm"
 />
 </div>
 </div>
 ...
 className={cn(
 "w-full p-4 flex gap-3 hover:bg-stone-50 transition-all border-b border-[#F3F4F6] text-left relative cursor-pointer",
 ...
 <div className={cn("absolute -bottom-1 -right-1 w-4 h-4 rounded-full flex items-center justify-center border-2 border-white", thread.channel === 'facebook' ? "bg-stone-900" : thread.channel === 'zalo' ? "bg-stone-800" : "bg-stone-500")}>
 ...
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center font-bold text-xs border border-stone-200 text-stone-500">
 ...
 msg.senderId === 'ai' ? "bg-stone-900 text-[#FAF9F5]" : "bg-stone-200 text-stone-500"
 )}>
 ...
 : "bg-stone-900 text-[#FAF9F5] rounded-br-sm"
 )}>
 {msg.text}
 </div>
 <div className="flex items-center gap-2 px-1">
 <span className={cn("text-[9px] font-medium tracking-wide", msg.senderId === 'ai' ? "text-stone-400" : "text-blue-300")}>{msg.senderName} • {msg.timestamp}</span>
 ...
 {isAiProcessing && (
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-full bg-stone-900 text-[#FAF9F5] flex items-center justify-center shadow-sm shadow-stone-900/5">
 <Bot className="w-4 h-4 animate-bounce" />
 </div>
 <div className="bg-white border border-stone-200 p-4 rounded-lg rounded-bl-sm shadow-sm flex items-center gap-3">
 <span className="text-xs text-stone-600 font-bold tracking-wide">AI Assistant đang soạn câu trả lời</span>
 <div className="flex gap-1.5">
 <div className="w-1.5 h-1.5 bg-stone-900 rounded-full animate-bounce [animation-delay:-0.3s]" />
 <div className="w-1.5 h-1.5 bg-stone-900 rounded-full animate-bounce [animation-delay:-0.15s]" />
 ...
 {/* Input Area */}
 <div className="p-4 bg-white border-t border-stone-200 flex flex-col gap-3">
 <div className="flex gap-2 p-1 overflow-x-auto hidden-scrollbar">
 <button className="px-3 py-1.5 bg-stone-100 hover:bg-stone-200 text-stone-600 text-xs font-bold rounded-full whitespace-nowrap transition-colors">Xin chào</button>
 <button className="px-3 py-1.5 bg-stone-100 hover:bg-stone-200 text-stone-600 text-xs font-bold rounded-full whitespace-nowrap transition-colors">Xin thông tin nhận hàng</button>
 <button className="px-3 py-1.5 bg-stone-100 hover:bg-stone-200 text-stone-600 text-xs font-bold rounded-full whitespace-nowrap transition-colors">Gửi mã freeship</button>
 <button className="px-3 py-1.5 bg-stone-100 hover:bg-stone-200 text-stone-600 text-xs font-bold rounded-full whitespace-nowrap transition-colors">Thông báo chậm hàng</button>
 </div>
 <div className="flex items-center gap-3">
 <button className="p-2.5 hover:bg-stone-100 rounded-lg text-stone-500 transition-all flex-shrink-0">
 ...
 className="w-full bg-stone-50 border border-stone-200 rounded-xl pl-4 pr-12 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-600/20 focus:border-stone-900 focus:bg-white transition-all font-medium"
 />
 <button className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-stone-900 hover:bg-stone-800 text-[#FAF9F5] rounded-lg transition-all disabled:opacity-50 flex items-center justify-center shadow-sm shadow-stone-900/5" onClick={handleSendMessage} disabled={isAiProcessing || !inputValue.trim()}>
 ...
 <div className="absolute bottom-full right-0 mb-2 whitespace-nowrap px-3 py-2 bg-stone-800 text-[#FAF9F5] text-xs font-bold rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
 Dùng AI trả lời
 </div>
 </button>
 </div>
 <div className="text-center mt-1">
 <p className="text-[9px] text-stone-400 font-bold uppercase tracking-[0.2em]">Được hỗ trợ bởi Gemini AI Engine</p>
 </div>
 </div>
 </div>

 {/* Right Sidebar - Info */}
 <div className="w-[280px] border-l border-[#F3F4F6] bg-stone-50/50 flex flex-col p-6 space-y-6 overflow-y-auto">
 ...
 <div key={order.id} className="p-3 bg-white rounded-lg border border-stone-200 shadow-sm space-y-1 hover:border-orange-200 transition-all cursor-pointer">
 <div className="flex justify-between items-start">
 ...
 {/* OmiCall Dialer */}
 <div className="w-1/3 border-r border-stone-200 bg-stone-50/50 p-6 flex flex-col items-center">
 <h3 className="font-bold text-stone-800 text-lg mb-2 text-center w-full">Tổng đài OmiCall (VoIP)</h3>
 ...
 <div className="bg-white w-full max-w-sm rounded-xl p-6 shadow-sm border border-stone-200 flex flex-col items-center">
 <div className="w-full bg-stone-100 h-16 rounded-lg flex items-center justify-center mb-8 text-2xl font-mono font-bold text-stone-700 tracing-widest">
 090 123 4567
 </div>
 
 <div className="grid grid-cols-3 gap-4 w-full px-4 mb-8">
 {[1,2,3,4,5,6,7,8,9,'*',0,'#'].map(num => (
 <button key={num} className="h-14 rounded-full bg-stone-50 hover:bg-stone-100 border border-stone-200 text-stone-700 text-xl font-bold flex items-center justify-center transition-all active:scale-95 shadow-sm">
 {num}
 </button>
 ))}
 </div>
 ...
 <h3 className="font-bold text-stone-800 text-lg flex items-center gap-2"><History className="w-5 h-5 text-orange-700" /> Lịch sử cuộc gọi (Call Logs)</h3>
 <button className="text-xs bg-stone-100 text-stone-600 px-3 py-1.5 rounded-lg font-bold hover:bg-stone-200 transition-all">Đồng bộ OmiCall API</button>
 </div>
 ...
 <thead>
 <tr className="bg-stone-50/50 border-b border-stone-100">
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest leading-relaxed">Khách hàng</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center leading-relaxed">Loại Hướng</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center leading-relaxed">Trạng thái</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center leading-relaxed">Thời lượng</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center leading-relaxed">File Ghi âm</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right leading-relaxed">Thời gian / Ghi chú</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-stone-100">
 {[
 ...
 <td className="px-6 py-4">
 <p className="text-sm font-bold text-stone-800">{log.name}</p>
 <p className="text-[10px] text-stone-500 font-mono mt-0.5">{log.caller}</p>
 </td>
 <td className="px-6 py-4 text-center">
 <span className={cn("px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest border", log.type === 'inbound' ? "border-orange-200 text-orange-700 bg-[#F2F0E9]" : "border-purple-200 text-purple-600 bg-purple-50")}>
 ...
 <td className="px-6 py-4 text-center text-sm font-mono text-stone-600 font-bold">
 {log.duration}
 </td>
 <td className="px-6 py-4 text-center">
 {log.hasAudio ? (
 <button className="inline-flex p-1.5 bg-[#F2F0E9] text-orange-700 rounded-lg items-center justify-center hover:bg-[#EAE7DF] transition-colors tooltip" title="Nghe lại">
 ...
 <td className="px-6 py-4 text-right">
 <div className="text-xs text-stone-500 font-medium mb-1 border-b border-dashed border-stone-200 pb-1 inline-block">
 {log.time}
 </div>
 <div>
 ...
 <button className="flex-1 text-xs font-bold py-1.5 rounded-md text-stone-500 hover:text-stone-700 transition-all text-center">Đang xử lý (5)</button>
 </div>
 </div>
 ...
 <div className="bg-white p-3 rounded-lg border border-stone-200 hover:border-stone-300 cursor-pointer transition-all opacity-70">
 <div className="flex justify-between items-start mb-1">
 <p className="text-sm font-bold text-stone-800">Khách vãng lai #885</p>
 <span className="text-[10px] text-stone-400">5p trước</span>
 </div>
 <p className="text-xs text-stone-600 truncate">Mình muốn đổi hàng thì làm sao?</p>
 <div className="mt-2 flex items-center gap-2">
 <span className="px-2 py-0.5 bg-stone-100 text-stone-500 rounded text-[9px] font-bold uppercase tracking-wider">Đã rời web</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="font-bold text-stone-800 text-sm">Khách vãng lai #889</h3>
 ...
 <div className="flex gap-2">
 <button className="px-3 py-1.5 text-xs font-bold text-stone-600 bg-stone-100 hover:bg-stone-200 rounded-lg transition-all">Lịch sử Duyệt web</button>
 ...
 <div className="text-center text-xs text-stone-400 font-medium my-4">— Cuộc trò chuyện bắt đầu lúc 10:24 —</div>
 <div className="flex flex-col gap-1 items-start">
 <div className="px-4 py-2 bg-white border border-stone-200 rounded-lg rounded-tl-sm text-sm text-stone-700 max-w-[70%] shadow-sm">
 Sản phẩm này có size XL không shop?
 </div>
 <span className="text-[10px] text-stone-400">10:24</span>
 </div>
 ...
 <span className="text-[10px] text-stone-400">10:28 ✓</span>
 </div>
 </div>
 )}
 ...
 {activeTab === 'agents' && (
 <div className="p-6 bg-stone-50 min-h-[600px]">
 <div className="flex items-center justify-between mb-8">
 <div>
 <h3 className="font-bold text-stone-800 text-xl flex items-center gap-2">
 <Users className="w-6 h-6 text-rose-600" /> Quản lý Đội ngũ CSKH & Extensions
 </h3>
 <p className="text-sm text-stone-500 mt-1">Phân công ca trực, thiết lập tổng đài viên và định tuyến ticket/cuộc gọi.</p>
 </div>
 <div className="flex gap-3">
 <button className="bg-white border border-stone-200 text-stone-600 px-4 py-2 rounded-lg text-sm font-bold hover:bg-stone-50 transition-all flex items-center gap-2">
 ...
 <div>
 <p className="text-2xl font-black text-stone-800">12</p>
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Đang Online</p>
 </div>
 </div>
 <div className="bg-white p-4 rounded-xl border border-stone-200 shadow-sm flex items-center gap-4">
 ...
 <div>
 <p className="text-2xl font-black text-stone-800">4</p>
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Đang nghe máy</p>
 </div>
 </div>
 <div className="bg-white p-4 rounded-xl border border-stone-200 shadow-sm flex items-center gap-4">
 ...
 <div>
 <p className="text-2xl font-black text-stone-800">45</p>
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Ticket đang chờ xử lý</p>
 </div>
 </div>
 </div>
 ...
 <tr>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest">Nhân viên</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center">Trạng thái</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest">SLA / Đánh giá</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center">EXT (Tổng đài)</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right">Thao tác</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-stone-100">
 ...
 <div>
 <p className="font-bold text-stone-800 text-sm">Nguyễn Ngọc Trinh</p>
 <p className="text-[10px] text-stone-500 uppercase tracking-wider font-medium">{roleScope === 'platform' ? 'Hỗ trợ Cửa Hàng (Platform)' : 'CSKH (Seller)'}</p>
 </div>
 </div>
 </td>
 <td className="px-6 py-4 text-center">
 ...
 <span className="text-xs text-stone-400">/ 120 SLA: 5p</span>
 </div>
 </td>
 <td className="px-6 py-4 text-center">
 <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-stone-100 rounded-lg text-xs font-mono font-bold text-stone-700">
 <Headset className="w-3.5 h-3.5 text-stone-400" /> 101
 </div>
 </td>
 <td className="px-6 py-4 text-right">
 <button className="p-2 text-stone-400 hover:text-orange-700 transition-colors">
 ...
 <div>
 <p className="font-bold text-stone-800 text-sm">Trần Minh Tuấn</p>
 <p className="text-[10px] text-stone-500 uppercase tracking-wider font-medium">{roleScope === 'platform' ? 'Xử lý Khiếu Nại (Platform)' : 'CSKH (Seller)'}</p>
 </div>
 </div>
 </td>
 <td className="px-6 py-4 text-center">
 ...
 <span className="text-xs text-stone-400">/ 85 SLA: 12p</span>
 </div>
 </td>
 <td className="px-6 py-4 text-center">
 <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-stone-100 rounded-lg text-xs font-mono font-bold text-stone-700">
 <Headset className="w-3.5 h-3.5 text-stone-400" /> 105
 </div>
 </td>
 <td className="px-6 py-4 text-right">
 <button className="p-2 text-stone-400 hover:text-orange-700 transition-colors">
 ...
 <tr className="hover:bg-stone-50 opacity-60 grayscale">
 <td className="px-6 py-4">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-full bg-stone-200 overflow-hidden">
 ...
 <div>
 <p className="font-bold text-stone-800 text-sm">Lê Văn A</p>
 <p className="text-[10px] text-stone-500 uppercase tracking-wider font-medium">{roleScope === 'platform' ? 'Hỗ trợ Cửa Hàng (Platform)' : 'CSKH (Seller)'}</p>
 </div>
 </div>
 </td>
 <td className="px-6 py-4 text-center">
 <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[10px] font-bold bg-stone-100 text-stone-500 border border-stone-200">
 <span className="w-1.5 h-1.5 bg-stone-400 rounded-full" /> Tạm nghỉ
 </span>
 </td>
 <td className="px-6 py-4">
 <div className="flex items-center gap-2">
 ...
 <span className="text-xs text-stone-400">/ 50 SLA: 15p</span>
 </div>
 </td>
 <td className="px-6 py-4 text-center">
 <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-stone-100 rounded-lg text-xs font-mono font-bold text-stone-700">
 <Headset className="w-3.5 h-3.5 text-stone-400" /> 102
 </div>
 </td>
 <td className="px-6 py-4 text-right">
 <button className="p-2 text-stone-400 hover:text-orange-700 transition-colors">
 ...
 <div>
 <h3 className="font-bold text-stone-800 text-xl flex items-center gap-2">
 <Settings className="w-6 h-6 text-stone-600" /> Cấu hình Kênh & Tích hợp (Omni-channel)
 </h3>
 <p className="text-sm text-stone-500 mt-1">Kết nối và quản lý các kênh giao tiếp với khách hàng tại một nơi.</p>
 </div>
 </div>
 ...
 <div>
 <h4 className="font-bold text-stone-800 text-lg">Facebook Fanpage</h4>
 <p className="text-xs text-stone-500">Đồng bộ tin nhắn & bình luận</p>
 </div>
 </div>
 ...
 <div>
 <p className="text-sm font-bold text-stone-800">VComm Official Store</p>
 ...
 <button className="w-full py-2.5 border-2 border-dashed border-stone-300 rounded-lg text-stone-600 font-bold text-sm hover:border-stone-900 hover:text-orange-700 transition-all flex justify-center items-center gap-2">
 ...
 <div className="flex justify-between items-start mb-6">
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 bg-stone-800/10 rounded-xl flex items-center justify-center text-orange-600">
 <MessageSquare className="w-6 h-6" />
 </div>
 <div>
 <h4 className="font-bold text-stone-800 text-lg">Zalo Official Account</h4>
 <p className="text-xs text-stone-500">Gửi ZNS & chat với khách hàng</p>
 </div>
 </div>
 ...
 <div className="space-y-4 mb-6 flex-1">
 <div className="p-3 bg-stone-50 rounded-lg border border-stone-100 flex justify-between items-center opacity-70 grayscale">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 bg-stone-200 rounded-full flex items-center justify-center text-stone-400">Z</div>
 <div>
 <p className="text-sm font-bold text-stone-800">Chưa kết nối OA nào</p>
 <p className="text-[10px] text-stone-500 font-bold">Cần cấu hình API OA</p>
 </div>
 </div>
 </div>
 ...
 <button className="w-full py-2.5 bg-stone-800 text-[#FAF9F5] rounded-lg font-bold text-sm hover:bg-stone-900 transition-all flex justify-center items-center gap-2 shadow-sm">
 ...
 <div>
 <h4 className="font-bold text-stone-800 text-lg">Mã nhúng Livechat Website</h4>
 ...
 <div>
 <h5 className="text-xs font-bold text-stone-700 uppercase mb-3">Tùy chỉnh giao diện</h5>
 <div className="space-y-4">
 <div>
 <label className="text-xs font-bold text-stone-600 block mb-1.5">Màu chủ đạo (Hex code)</label>
 <div className="flex gap-2">
 <input type="color" value="#4F46E5" readOnly className="w-8 h-8 rounded border-none cursor-pointer" />
 <input type="text" value="#4F46E5" readOnly className="flex-1 bg-stone-50 border border-stone-200 rounded-lg px-3 py-1 font-mono text-sm text-stone-600" />
 </div>
 </div>
 <div>
 <label className="text-xs font-bold text-stone-600 block mb-1.5">Lời chào mặc định</label>
 <input type="text" value="Chào bạn, VComm có thể giúp gì cho bạn?" readOnly className="w-full bg-stone-50 border border-stone-200 rounded-lg px-3 py-2 text-sm text-stone-600 font-medium" />
 </div>
 </div>
 </div>
 
 <div>
 <h5 className="text-xs font-bold text-stone-700 uppercase mb-3">Copy JavaScript Snippet</h5>
 <div className="relative">
 <pre className="bg-stone-900 text-emerald-400 p-4 rounded-xl text-[11px] font-mono overflow-x-auto">
{`<script>
...
<script src="https://cdn.vcomm.io/chat.js" async></script>`}
 ...
 <button className="absolute top-2 right-2 bg-white/10 hover:bg-white/20 text-[#FAF9F5] rounded p-1.5 transition-all text-[10px] font-bold">Copy Code</button>
 </div>
 <p className="text-[10px] text-stone-500 mt-2 italic">* Chèn đoạn mã này vào thẻ &lt;head&gt; hoặc trước thẻ đóng &lt;/body&gt; trên website của bạn.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 className="relative w-full max-w-lg bg-white shadow-sm border-l border-stone-200 flex flex-col z-10"
 >
 <div className="p-6 border-b border-stone-100 bg-stone-50/50 flex justify-between items-start">
 <div>
 <h2 className="text-lg font-bold text-stone-800 break-words pr-4">{selectedTicket.subject}</h2>
 <div className="flex items-center gap-3 mt-2">
 <span className="text-xs font-mono font-bold text-stone-400 uppercase">{selectedTicket.id}</span>
 <span className={cn(
 ...
 <button onClick={() => setSelectedTicket(null)} className="p-2 bg-stone-100 text-stone-500 rounded-full hover:bg-stone-200 transition-colors shrink-0">
 ...
 <div>
 <p className="text-sm font-bold text-stone-800">{selectedTicket.customerName}</p>
 <p className="text-xs text-stone-500">Khách hàng Vàng • 12 đơn hàng</p>
 </div>
 </div>
 ...
 <textarea 
 className="w-full h-32 border border-stone-200 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-600 focus:border-transparent transition-all resize-none bg-stone-50"
 ...
 <button className="bg-stone-900 text-[#FAF9F5] px-6 py-2.5 rounded-lg text-sm font-bold shadow-sm hover:bg-stone-800 transition-all">
 Gửi & Đóng Ticket
 </button>
 </div>
 </div>
