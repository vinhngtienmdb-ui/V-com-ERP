        ...
        <div className="flex gap-4 overflow-x-auto no-scrollbar py-2">
          {categories.map(cat => (
            <button
              ...
              className={cn(
                "px-5 py-2.5 rounded-2xl text-xs font-bold transition-all whitespace-nowrap shadow-sm border",
      ...
      <main className="flex-1 px-6 py-6 space-y-6 pb-32">
        <div className="relative mb-8">
           ...
           <input 
             ...
             className="w-full bg-white border border-slate-200 rounded-2xl pl-12 pr-4 py-4 text-sm font-medium focus:outline-none focus:border-indigo-500 transition-all shadow-sm"
             value={searchQuery}
          ...
          {filteredProducts.map(product => {
            ...
            return (
              <motion.div 
                layout
                key={product.id} 
                className="bg-white rounded-3xl p-4 flex gap-4 border border-slate-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden"
              >
                <div className="w-24 h-24 bg-slate-50 rounded-2xl flex-shrink-0 overflow-hidden border border-slate-50">
                  <img 
        ...
        {cartCount > 0 && (
          ...
          >
            ...
            <button 
              ...
              className="bg-indigo-600 text-white px-8 h-12 rounded-2xl font-bold flex items-center gap-2 active:scale-95 transition-all shadow-lg shadow-indigo-600/30 disabled:opacity-50"
            >
              Đặt món ngay
