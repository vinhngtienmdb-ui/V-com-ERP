...
export function Finance() {
 ...
 <span className="text-[10px] text-rose-600 font-bold bg-rose-50 px-2 py-0.5 rounded">Đồng bộ dữ liệu</span>
 </div>
 </div>
 <div className="bg-white p-5 rounded-xl border border-slate-300 shadow-sm hover:shadow-sm transition-all">
 <div className="flex justify-between items-start mb-3">
 ...
 <div className="flex items-end justify-between">
 <span className="text-xl font-bold text-[#FAF9F5]">Điểm tin cậy: 9.8</span>
 <span className="text-[10px] text-[#FAF9F5] font-bold bg-white/20 px-2 py-0.5 rounded underline cursor-pointer">Xác minh</span>
 </div>
 </div>
 </DraggableGrid>
