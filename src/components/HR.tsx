...
export function HumanResources() {
 ...
 <div className="flex items-center gap-2 mr-4 bg-stone-100 p-1.5 rounded-lg border border-stone-200">
 ...
 <button className="bg-white border border-[#E5E7EB] px-4 py-2 rounded-lg text-sm font-bold text-[#4B5563] hover:bg-stone-50 transition-all flex items-center gap-2 shadow-sm">
 ...
 <div className="mt-3 flex items-center gap-1.5 text-[10px] text-orange-700 font-bold bg-[#F2F0E9] px-2 py-0.5 rounded w-fit">
 ...
 <p className="text-[10px] text-stone-400 mt-3 font-bold italic uppercase tracking-tighter">Tăng 5.2% so với T2</p>
 </div>
 ...
 <div className="flex justify-between items-start mb-4">
 <span className="text-[10px] text-stone-400 font-bold uppercase tracking-widest">Skill Health</span>
 ...
 <h4 className="text-xs font-bold text-stone-500 uppercase tracking-widest text-center">Tỷ lệ Tuyển dụng & Nghỉ việc</h4>
 ...
 <div className="h-72 w-full space-y-2">
 <h4 className="text-xs font-bold text-stone-500 uppercase tracking-widest text-center">Biểu đồ Vi phạm Chấm công</h4>
 <ResponsiveContainer width="100%" height="100%">
 ...
 <div className="p-5 bg-[#F2F0E9]/50 border border-[#EAE7DF] rounded-lg">
 ...
 <span className="text-[10px] font-bold text-stone-500 uppercase tracking-widest block mb-1">Time to Fill</span>
 ...
 <div className="p-4 bg-stone-50 border border-stone-100 rounded-lg">
 <span className="text-[10px] font-bold text-stone-500 uppercase tracking-widest block mb-1">Employee NPS</span>
 ...
 className="bg-stone-50 border border-stone-200 rounded-lg p-5 hover:border-blue-300 hover:shadow-sm hover:bg-white transition-all text-left flex gap-4 items-start group"
 >
 ...
 m.status === 'Done' ? "bg-emerald-50 text-emerald-600" : "bg-[#F2F0E9] text-orange-700"
 )}>{m.status}</span>
 </div>
 <div className="h-2 bg-stone-50 rounded-full overflow-hidden">
 <div className={cn("h-full transition-all duration-1000", m.status === 'Done' ? "bg-emerald-500" : "bg-stone-800")} style={{ width: `${m.progress}%` }} />
 </div>
 </div>
 ))}
 <button className="w-full py-4 bg-[#111827] text-[#FAF9F5] text-xs font-bold rounded-lg hover:bg-stone-800 transition-all uppercase tracking-[0.2em] shadow-sm shadow-stone-900/20">Quản lý lộ trình Onboarding</button>
 </div>
 <LucidePieChart className="absolute -bottom-12 -right-12 w-48 h-48 text-stone-50 group-hover:scale-110 transition-transform duration-700" />
 </div>

 <div className="bg-white from-[#2563EB] to-[#1E40AF] p-10 rounded-lg text-[#FAF9F5] relative overflow-hidden shadow-sm flex flex-col justify-between">
 ...
 <div className="h-48 bg-stone-50 rounded-lg border border-[#F3F4F6] relative overflow-hidden flex items-center justify-center">
 <div className="text-center space-y-2 opacity-40">
 <MapPin className="w-8 h-8 mx-auto" />
 <p className="text-xs font-medium">Bản đồ GPS đang hoạt động (Mock)</p>
 </div>
 <div className="absolute top-10 left-20 w-3 h-3 bg-stone-800 rounded-full border-2 border-white animate-pulse shadow-sm"></div>
 ...
 <div className="bg-white text-[#FAF9F5] p-8 rounded-lg flex flex-col justify-between">
 <div>
 <h3 className="text-xl font-bold italic mb-2">Dynamic Salary Engine</h3>
 <p className="text-stone-400 text-sm leading-relaxed">Cấu hình công thức tính lương động theo từng vị trí (Kinh doanh: Lương cứng + % Hoa hồng; Kho: Lương theo sản lượng). Tự động kết nối dữ liệu từ module Seller & Đơn hàng để tính thưởng nóng.</p>
 </div>
 <div className="pt-6">
 <button className="w-full bg-white text-stone-900 font-bold py-3 rounded-lg text-sm hover:bg-stone-100 transition-all flex items-center justify-center gap-2">
 ...
 <div className="p-6 border-b border-[#F3F4F6] bg-stone-50/50">
 <button 
 onClick={() => setActiveTab('overview')} 
 className="flex items-center gap-2 text-sm font-bold text-stone-500 hover:text-orange-700 transition-colors bg-white border border-stone-200 px-4 py-2 rounded-lg w-fit shadow-sm"
 >
 ...
 className="bg-stone-50 border border-stone-200 rounded-lg px-10 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-600/20 w-64 transition-all" 
 />
 </div>
 {activeTab === 'personnel' && (
 ...
 className="bg-white border border-stone-200 rounded-lg px-3 py-2 text-sm font-medium text-stone-600 focus:outline-none focus:ring-2 focus:ring-orange-600/20"
 >
 ...
 className={cn("px-3 py-1.5 text-xs font-bold rounded-md transition-colors", attendanceView === 'week' ? "bg-white text-orange-700 shadow-sm" : "text-stone-500 hover:text-stone-700")}
 >
 Theo Tuần
 </button>
 <button 
 onClick={() => setAttendanceView('month')}
 className={cn("px-3 py-1.5 text-xs font-bold rounded-md transition-colors", attendanceView === 'month' ? "bg-white text-orange-700 shadow-sm" : "text-stone-500 hover:text-stone-700")}
 >
 Theo Tháng
 </button>
 </div>
 ...
 <button className="bg-white border border-stone-200 px-4 py-2 rounded-lg text-xs font-bold text-stone-600 hover:bg-stone-50 transition-all flex items-center gap-2">
 <History className="w-4 h-4" /> Nhật ký thay đổi
 </button>
 </div>
 ) : (
 <button className="bg-stone-900 text-[#FAF9F5] px-4 py-2 rounded-lg text-xs font-bold flex items-center gap-2 hover:bg-stone-800 transition-all shadow-sm shadow-stone-900/5 w-max">
 ...
 <h2 className="text-xl font-bold flex items-center gap-2 text-stone-900"><Settings className="w-6 h-6 text-orange-700"/> Cấu hình Hệ thống Chấm công</h2>
 <p className="text-sm text-stone-500 font-medium">Thiết lập các phương thức và quy tắc xác thực chấm công cho toàn doanh nghiệp.</p>
 </div>
 </div>
 ...
 setting.enabled ? "border-orange-200 ring-1 ring-blue-50/50" : "border-stone-200 opacity-80"
 )}>
 ...
 setting.enabled ? "bg-stone-900 text-[#FAF9F5] shadow-sm shadow-blue-200" : "bg-stone-100 text-stone-400"
 )}>
 ...
 <p className="text-stone-500 text-xs font-medium uppercase tracking-wider mt-0.5">Protocol: {setting.method}</p>
 </div>
 </div>
 ...
 setting.enabled ? "bg-stone-900" : "bg-stone-200"
 )}
 >
 <span className={cn(
 ...
 <span className={cn("text-[10px] font-bold uppercase", setting.enabled ? "text-orange-700" : "text-stone-400")}>
 {setting.enabled ? 'Đang bật' : 'Đã tắt'}
 </span>
 </div>
 </div>
 
 <div className="p-6 bg-stone-50/30 flex-1">
 {setting.enabled ? (
 ...
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Bán kính mặc định (m)</label>
 <div className="relative">
 <input 
 type="number" 
 value={setting.config.radius}
 onChange={(e) => updateSettingConfig('gps', 'radius', Number(e.target.value))}
 className="w-full border border-stone-200 rounded-lg px-4 py-2.5 text-sm font-mono focus:ring-2 focus:ring-orange-600/10 focus:border-stone-900 outline-none"
 />
 <Timer className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-stone-300" />
 </div>
 </div>
 <div className="space-y-1.5">
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Số lượng Vùng</label>
 <div className="px-4 py-2.5 bg-white border border-stone-200 rounded-lg text-sm font-bold text-orange-700 flex justify-between items-center">
 ...
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Danh sách Vùng an toàn</label>
 <div className="space-y-2">
 {setting.config.zones?.map((zone: any, i: number) => (
 <div key={i} className="bg-white border border-stone-200 p-3 rounded-lg flex justify-between items-center group/item hover:border-blue-300 transition-colors">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-lg bg-[#F2F0E9] flex items-center justify-center text-orange-600"><MapPin className="w-4 h-4" /></div>
 <div>
 <p className="text-xs font-bold text-stone-800">{zone.name}</p>
 <p className="text-[10px] text-stone-500 font-mono italic">{zone.lat}, {zone.lng} (±{zone.radius}m)</p>
 </div>
 </div>
 <button className="p-2 text-stone-300 hover:text-red-500 opacity-0 group-hover/item:opacity-100 transition-all"><Trash2 className="w-4 h-4" /></button>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="space-y-4">
 <div className="space-y-1.5">
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Danh sách Wi-Fi Tin cậy</label>
 <div className="flex flex-wrap gap-2">
 {setting.config.ssids?.map((ssid: string, i: number) => (
 <div key={i} className="flex items-center gap-2 bg-[#F2F0E9] text-orange-800 px-3 py-1.5 rounded-lg border border-[#EAE7DF] text-xs font-bold">
 <Wifi className="w-3 h-3" />
 {ssid}
 <button className="hover:text-blue-900 ml-1">×</button>
 </div>
 ))}
 <button className="flex items-center gap-2 border border-dashed border-stone-300 px-3 py-1.5 rounded-lg text-xs font-bold text-stone-400 hover:border-blue-400 hover:text-orange-600 transition-all">
 ...
 <div>
 <p className="text-xs font-bold text-stone-800">Xác thực qua MAC Address</p>
 <p className="text-[10px] text-stone-500 font-medium">Bảo mật cao nhất cho môi trường văn phòng.</p>
 </div>
 </div>
 <input type="checkbox" defaultChecked={setting.config.macRestricted} className="w-5 h-5 rounded border-stone-300 text-orange-700 focus:ring-orange-600" />
 </div>
 </div>
 )}
 {setting.method === 'face' && (
 <div className="space-y-4">
 <div className="space-y-1.5">
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Độ chính xác yêu cầu (0.8 - 0.99)</label>
 <div className="flex items-center gap-4">
 <input 
 type="range" 
 min="0.5" 
 ...
 />
 <span className="text-sm font-mono font-bold text-orange-700 bg-[#F2F0E9] px-3 py-1 rounded-lg border border-[#EAE7DF]">{setting.config.minMatch}</span>
 </div>
 </div>
 ...
 <label key={feat.id} className="flex items-center justify-between p-3 bg-white border border-stone-200 rounded-lg cursor-pointer hover:bg-stone-50 transition-colors">
 <div className="flex items-center gap-3">
 <feat.icon className="w-4 h-4 text-orange-600" />
 <span className="text-xs font-bold text-stone-700">{feat.label}</span>
 </div>
 <input 
 type="checkbox" 
 ...
 <div className="space-y-4">
 <div className="space-y-1.5">
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Thời gian làm mới mã (giây)</label>
 <div className="relative">
 <input 
 type="number" 
 ...
 <div className="grid grid-cols-2 gap-4">
 <div className="space-y-1.5">
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Địa chỉ IP thiết bị</label>
 <input 
 type="text" 
 ...
 <div className="space-y-1.5">
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Cổng kết nối (Port)</label>
 <input 
 type="number" 
 ...
 <div className="space-y-1.5">
 <label className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">Model thiết bị & Giao thức</label>
 <select 
 value={setting.config.model}
 onChange={(e) => updateSettingConfig('device', 'model', e.target.value)}
 className="w-full border border-stone-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-orange-600/10 focus:border-stone-900 outline-none bg-white font-bold"
 >
 ...
 <p className="text-xs font-bold text-stone-800">Khoảng cách đồng bộ</p>
 <p className="text-[10px] text-stone-500 uppercase font-bold tracking-tight">Sync every {setting.config.syncInterval} minutes</p>
 </div>
 <div className="flex gap-2">
 <button className="px-4 py-2 bg-stone-900 text-[#FAF9F5] rounded-lg text-xs font-bold hover:bg-stone-800 transition-all">Ping test</button>
 <button className="p-2 bg-[#F2F0E9] text-orange-700 rounded-lg hover:bg-[#EAE7DF] transition-all border border-[#EAE7DF]"><Zap className="w-4 h-4 fill-current" /></button>
 </div>
 </div>
 </div>
 )}
 ...
 <div>
 <p className="text-sm font-bold text-stone-400">Phương thức này đang tắt</p>
 <p className="text-xs text-stone-300 mt-1">Bật switch để cấu hình chi tiết cho hệ thống.</p>
 </div>
 </div>
 )}
 </div>
 ...
 <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest italic">Last Update: 2 mins ago</span>
 <button className={cn(
 "text-xs font-bold transition-all flex items-center gap-2",
 setting.enabled ? "text-orange-700 hover:text-blue-800" : "text-stone-300 cursor-not-allowed"
 )}>
 ...
 <thead>
 <tr className="bg-stone-50/50 border-b border-[#F3F4F6]">
 {activeTab === 'personnel' && (
 <>
 ...
 <tr key={emp.id} onClick={() => setSelectedEmployee(emp)} className="hover:bg-stone-50 transition-colors cursor-pointer group">
 ...
 <span className="text-[10px] font-bold text-stone-500 bg-stone-100 px-2 py-0.5 rounded-lg uppercase">
 ...
 {emp.recentSentiment === 'neutral' && <span className="text-stone-500 flex items-center gap-1"><MoreVertical className="w-3.5 h-3.5"/> OK</span>}
 ...
 <td className="px-6 py-5 text-right font-bold text-sm text-stone-700">10,000,000 ₫</td>
 <td className="px-6 py-5 text-center">
 <p className="text-xs font-bold text-stone-800">10.5% - 21.5%</p>
 </td>
 <td className="px-6 py-5 text-center">
 ...
 <span key={idx} className="px-2 py-0.5 bg-[#F2F0E9] text-orange-700 text-[10px] font-bold rounded-lg border border-[#EAE7DF]">
 {s.name}
 </span>
 ))}
 </div>
 ...
 <div className="h-full bg-stone-800" style={{ width: `${(emp.skills?.[0]?.level || 50)}%` }} />
 </div>
 <span className="text-[10px] font-bold text-stone-400">{(emp.skills?.[0]?.level || 50)}% Mastered</span>
 </div>
 </td>
 ...
 <button className="px-4 py-1.5 bg-stone-900 text-[#FAF9F5] rounded-lg text-[10px] font-bold hover:bg-stone-800 transition-all uppercase tracking-widest shadow-sm">Đề cử Training</button>
 </td>
 </tr>
 ))}
 ...
 <span className="text-[10px] text-stone-400 ml-1">ngày</span>
 </td>
 <td className="px-6 py-5 text-center">
 ...
 return (
 <tr key={kpi.id} className="hover:bg-stone-50 transition-colors">
 <td className="px-6 py-5">
 ...
 <p className="text-[10px] text-stone-400 mt-1 uppercase tracking-tight">Kỳ đánh giá: {kpi.period}</p>
 </td>
 <td className="px-6 py-5 text-center">
 <span className="text-sm font-bold text-stone-600">{kpi.target.toLocaleString()} {kpi.unit}</span>
 </td>
 <td className="px-6 py-5 text-center">
 ...
 <span className="text-stone-400">{progress >= 100 ? 'Đạt' : 'Đang xử lý'}</span>
 </div>
 <div className="h-1.5 w-full bg-stone-100 rounded-full overflow-hidden">
 <div className={cn("h-full rounded-full transition-all duration-1000", progress >= 100 ? "bg-emerald-500" : "bg-stone-800")} style={{ width: `${Math.min(progress, 100)}%` }} />
 </div>
 </div>
 </td>
 </tr>
 ...
 {emp.recentSentiment === 'neutral' && <span className="text-stone-500 flex items-center gap-1 bg-stone-100 px-3 py-1.5 rounded-lg"><MoreVertical className="w-4 h-4"/> Neutral</span>}
 ...
 <td className="px-6 py-5 text-center">
 <p className="text-[10px] font-medium text-stone-500 leading-relaxed max-w-[200px] mx-auto text-left">
 ...
 <td className="px-6 py-5">
 <p className="text-[10px] font-bold text-orange-700 bg-[#F2F0E9] px-3 py-1.5 rounded-lg max-w-[150px]">
 {emp.recentSentiment === 'critical' ? 'Đề nghị nghỉ dưỡng / 1-1 meeting' : 'Không có đề xuất'}
 </p>
 </td>
 <td className="px-6 py-5 text-right">
 <button className="px-3 py-1.5 bg-stone-900 text-[#FAF9F5] rounded-lg text-[10px] font-bold hover:bg-stone-800 transition-all shadow-sm">Lên lịch 1-on-1</button>
 </td>
 </tr>
 ))}
 {activeTab === 'teams' && (
 ...
 <p className="text-sm text-stone-500">{team.type}</p>
 ...
 <td className="px-6 py-5">
 <p className="text-sm font-bold text-stone-800">{emp?.fullName ?? 'Hệ thống'}</p>
 <p className="text-[10px] text-stone-500 font-bold uppercase tracking-widest">{record.date}</p>
 </td>
 <td className="px-6 py-5 text-center">
 ...
 <span className="text-[10px] font-bold text-stone-400 mt-1 bg-stone-100 px-2 py-0.5 rounded-full">{hoursWorked} giờ (OT: {record.overtimeHours}h)</span>
 </div>
 </td>
 <td className="px-6 py-5">
 <div className="flex items-center gap-3">
 ...
 <div>
 <p className="text-xs font-bold text-stone-800 uppercase tracking-tight">{record.method}</p>
 <p className="text-[10px] text-stone-500">{record.deviceInfo}</p>
 </div>
 </div>
 </td>
 <td className="px-6 py-5">
 <p className="text-xs font-medium text-stone-600">{record.location}</p>
 </td>
 <td className="px-6 py-5 text-right">
 <div className="flex flex-col items-end gap-2">
 <span className={cn(
 ...
 {activeTab === 'attendance' && (
 <div className="space-y-6 animate-in fade-in slide-in- duration-500 p-6 bg-stone-50 min-h-[600px]">
 <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-xl border border-stone-200 shadow-sm mb-6">
 <div>
 <h2 className="text-xl font-bold text-stone-900 flex items-center gap-2">
 <Clock className="w-6 h-6 text-orange-500" /> Quản lý Chấm công & Hiện diện
 </h2>
 <p className="text-[10px] text-stone-500 font-medium mt-1 uppercase tracking-wider">Dữ liệu được đồng bộ từ App GPS, Wifi Hub và Máy chấm công FaceID</p>
 </div>
 <div className="flex gap-3">
 <button 
 onClick={() => setShowAttendanceConfig(true)}
 className="px-4 py-2 bg-stone-100 text-stone-700 text-xs font-bold rounded-lg hover:bg-stone-200 flex items-center gap-2"
 >
 ...
 activeAttendanceMethod === 'kiosk' ? "bg-orange-600 text-[#FAF9F5] shadow-sm shadow-orange-100" : "bg-white border border-stone-200 text-stone-700"
 )}
 >
 ...
 <div className="w-64 h-64 bg-stone-800 rounded-xl border-4 border-stone-700 relative flex items-center justify-center overflow-hidden group">
 <div className="absolute inset-0 bg-stone-800/10 opacity-100" />
 <div className="absolute top-0 left-0 w-full h-1 bg-stone-800 shadow-[0_0_15px_rgba(59,130,246,0.8)] animate-[scan_3s_ease-in-out_infinite]" />
 <ScanFace className="w-24 h-24 text-orange-500/50 group-hover:text-orange-500 transition-colors" />
 
 <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 text-[10px] text-stone-400 font-bold uppercase tracking-tighter">
 ...
 <h3 className="font-black text-stone-900 text-sm uppercase tracking-widest mb-6 flex items-center gap-2">
 ...
 <div>
 <p className="text-xs font-bold text-stone-900 uppercase tracking-tight">{l.name}</p>
 <p className="text-[10px] text-stone-500 font-medium">Verify: FaceID (Match 98%) • {l.dept}</p>
 </div>
 </div>
 <div className="text-right">
 <p className="text-sm font-black text-stone-900">{l.time}</p>
 <p className={cn(
 ...
 <div className="col-span-12 lg:col-span-8 bg-white rounded-lg border border-stone-200 shadow-sm overflow-hidden flex flex-col">
 ...
 <th className="px-6 py-4 text-[10px] font-bold text-stone-400 uppercase tracking-widest">Nhân viên</th>
 <th className="px-6 py-4 text-[10px] font-bold text-stone-400 uppercase tracking-widest text-center">Ca làm</th>
 <th className="px-6 py-4 text-[10px] font-bold text-stone-400 uppercase tracking-widest text-center">In/Out</th>
 <th className="px-6 py-4 text-[10px] font-bold text-stone-400 uppercase tracking-widest text-center">Verify</th>
 <th className="px-6 py-4 text-[10px] font-bold text-stone-400 uppercase tracking-widest text-center">Trạng thái</th>
 <th className="px-6 py-4 text-[10px] font-bold text-stone-400 uppercase tracking-widest text-right">Lương ca</th>
 </tr>
 </thead>
 ...
 <td className="px-6 py-5 text-center">
 <span className="text-[9px] font-bold text-stone-600 px-2 py-0.5 bg-stone-100 rounded uppercase tracking-tighter">Hành chính</span>
 </td>
 <td className="px-6 py-5 text-center">
 <div className="flex flex-col items-center">
 <div className="text-xs font-black text-stone-900 tabular-nums">{att.checkIn} - {att.checkOut || '--:--'}</div>
 <div className="text-[9px] text-stone-400 font-bold uppercase tracking-widest mt-1 opacity-70">Total: {att.overtimeHours + 8}h</div>
 </div>
 </td>
 <td className="px-6 py-5 text-center">
 <div className="flex flex-col items-center gap-1">
 {att.method === 'face' ? (
 <div className="px-2 py-0.5 bg-[#F2F0E9] text-orange-700 rounded flex items-center gap-1 text-[9px] font-bold">
 ...
 <span className="text-[9px] text-stone-400 font-medium">{att.deviceInfo}</span>
 </div>
 </td>
 <td className="px-6 py-5 text-center">
 <span className={cn(
 ...
 <td className="px-6 py-5 text-right">
 <span className="text-xs font-black text-stone-900 tabular-nums">{formatCurrency(450000)}</span>
 </td>
 </tr>
 );
 })}
 ...
 <h3 className="font-bold text-stone-900 text-sm mb-6 flex items-center gap-2 uppercase tracking-widest">
 <Target className="w-4 h-4 text-rose-500" /> Phân tích Chuyên cần
 </h3>
 <div className="space-y-6">
 <div className="flex justify-between items-end">
 <div>
 <p className="text-4xl font-black text-stone-900 tracking-tighter">94.2%</p>
 <p className="text-[10px] text-stone-500 font-bold uppercase mt-1 tracking-widest">Tỷ lệ Presence Rate</p>
 </div>
 ...
 <span className="text-stone-500 uppercase">{s.label}</span>
 <span className="text-stone-900 font-black">{s.count} người</span>
 </div>
 <div className="h-1.5 bg-stone-100 rounded-full overflow-hidden">
 <div 
 className={cn("h-full transition-all duration-1000", s.color === 'emerald' ? 'bg-emerald-500' : s.color === 'rose' ? 'bg-rose-500' : 'bg-stone-800')} 
 ...
 <div className="col-span-12 lg:col-span-8 bg-white border border-stone-200 rounded-xl overflow-hidden shadow-sm">
 <div className="p-6 border-b border-stone-100 bg-stone-50/50 flex justify-between items-center px-8">
 <h3 className="font-black text-stone-900 text-sm uppercase tracking-[0.2em]">Bảng theo dõi mục tiêu chi tiết</h3>
 <div className="relative">
 ...
 <thead>
 <tr className="bg-stone-50/30 border-b border-stone-100 text-left">
 <th className="px-8 py-5 text-[10px] font-bold text-stone-400 uppercase tracking-widest">Nhân sự & Vị trí</th>
 <th className="px-8 py-5 text-[10px] font-bold text-stone-400 uppercase tracking-widest">Chỉ tiêu trọng yếu</th>
 <th className="px-8 py-5 text-[10px] font-bold text-stone-400 uppercase tracking-widest text-center">Tiến độ (%)</th>
 <th className="px-8 py-5 text-[10px] font-bold text-stone-400 uppercase tracking-widest text-right">Phân tích AI</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-stone-50">
 {MOCK_KPIs.map(kpi => {
 ...
 const progress = (kpi.current / kpi.target) * 100;
 return (
 <tr key={kpi.id} className="hover:bg-stone-50/80 transition-colors group">
 <td className="px-8 py-5">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-xl bg-stone-100 flex items-center justify-center font-black text-stone-900 text-sm shadow-sm group-hover:bg-white transition-all">
 {emp?.fullName.split(' ').pop()?.charAt(0)}
 </div>
 <div>
 <p className="text-sm font-black text-stone-900 italic tracking-tight">{emp?.fullName}</p>
 <p className="text-[10px] text-stone-400 font-bold uppercase">{emp?.department}</p>
 </div>
 </div>
 </td>
 <td className="px-8 py-5">
 <p className="text-xs font-bold text-stone-800">{kpi.title}</p>
 <p className="text-[10px] text-stone-400 mt-1 uppercase tracking-tighter">Target: {kpi.target} {kpi.unit}</p>
 </td>
 ...
 <span className="text-stone-300 font-mono italic">#{kpi.id.slice(-4)}</span>
 </div>
 <div className="h-2 w-full bg-stone-100 rounded-full overflow-hidden shadow-inner">
 <div 
 className={cn("h-full transition-all duration-1000", progress >= 100 ? "bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.4)]" : progress >= 80 ? "bg-stone-800" : "bg-rose-500")} 
 ...
 progress >= 100 ? "bg-emerald-100 text-emerald-700" : "bg-stone-100 text-stone-600"
 )}>
 {progress >= 100 ? 'OUTSTANDING' : 'ON TRACK'}
 </div>
 <p className="text-[9px] text-stone-400 italic">Dự báo: 112% (AI)</p>
 </div>
 </td>
 </tr>
 );
 ...
 <div className="bg-stone-900 rounded-xl p-8 text-[#FAF9F5] relative overflow-hidden shadow-sm">
 ...
 { name: 'Thu Thủy', score: 94, rank: 2, color: 'text-stone-300' },
 ...
 <p className="text-[9px] text-stone-500 font-bold uppercase">Points</p>
 </div>
 </div>
 ))}
 </div>
 ...
 <div className="bg-white border border-stone-200 rounded-xl p-8 shadow-sm group">
 ...
 <div className="p-8 bg-stone-50 min-h-[500px]">
 <div className="flex justify-between items-center mb-8">
 <div>
 <h2 className="text-xl font-bold flex items-center gap-2 text-stone-800"><Wallet className="w-6 h-6 text-orange-700"/> Quản lý Quỹ lương & Payslip</h2>
 <p className="text-xs text-stone-500 mt-1">Kỳ lương hiển thị: <strong className="text-stone-700">Tháng 03/2024</strong></p>
 </div>
 <div className="flex gap-3">
 <button 
 onClick={() => {
 ...
 className="bg-[#2563EB] text-[#FAF9F5] px-5 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 shadow-sm shadow-stone-900/5 active:scale-95 transition-all hover:bg-stone-800 ml-3">
 <ArrowRight className="w-4 h-4" /> Kết chuyển sang Finance (P&L)
 </button>
 <button className="bg-[#111827] text-[#FAF9F5] px-5 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 shadow-sm shadow-stone-900/20 active:scale-95 transition-all hover:bg-stone-800">
 ...
 <div className="bg-white p-5 rounded-lg border border-stone-200 shadow-sm relative overflow-hidden group">
 <div className="absolute right-0 top-0 w-24 h-24 bg-[#F2F0E9] rounded-bl-full -z-0 opacity-50 transition-transform group-hover:scale-110" />
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest relative z-10 mb-1">Tổng lương cơ bản</p>
 <p className="text-2xl font-bold text-stone-800 relative z-10">{formatCurrency(payrollList.reduce((acc, pay) => acc + pay.baseSalary, 0))}</p>
 </div>
 <div className="bg-white p-5 rounded-lg border border-stone-200 shadow-sm relative overflow-hidden group">
 ...
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest relative z-10 mb-1">Tổng Phụ cấp & Thưởng</p>
 ...
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest relative z-10 mb-1">Thuế TNCN & BH</p>
 ...
 <div className="bg-white from-[#111827] p-5 rounded-lg border border-stone-700 shadow-sm relative overflow-hidden group">
 <div className="absolute right-0 top-0 w-24 h-24 bg-white/5 rounded-bl-full -z-0 transition-transform group-hover:scale-110" />
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest relative z-10 mb-1">Tổng chi trả Thực tế (Net Pay)</p>
 ...
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest">Mã / Tên Nhân viên</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right">Lương Cơ bản</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right">Thưởng / Phụ cấp</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right">Khấu trừ (Thuế, BH)</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right">Thực lãnh</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-center">Trạng thái</th>
 <th className="px-6 py-4 text-[11px] font-bold text-stone-500 uppercase tracking-widest text-right">Bảng lương</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-stone-100">
 {payrollList.map((pay) => (
 <tr key={pay.id} className="hover:bg-[#F2F0E9]/30 transition-colors group">
 <td className="px-6 py-4">
 <p className="text-sm font-bold text-stone-800">{pay.employeeName}</p>
 <p className="text-[10px] text-stone-400 uppercase tracking-widest font-bold mt-0.5">{pay.employeeId}</p>
 </td>
 <td className="px-6 py-4 text-right font-mono font-bold text-sm text-stone-600">{formatCurrency(pay.baseSalary)}</td>
 ...
 <td className="px-6 py-4 text-right">
 <p className="text-[15px] font-bold text-[#2563EB] font-mono bg-[#F2F0E9] px-3 py-1 rounded-lg inline-block">{formatCurrency(pay.netSalary)}</p>
 </td>
 <td className="px-6 py-4">
 <div className="flex justify-center">
 <span className={cn(
 ...
 <div className="bg-stone-50 border-t border-stone-100 p-4 text-xs text-stone-500 font-medium flex justify-between items-center">
 ...
 <h3 className="text-lg font-bold text-stone-800">Cập nhật Lương ({editPayrollForm.employeeName})</h3>
 <button onClick={() => setEditingPayrollId(null)} className="p-2 text-stone-400 hover:text-stone-600 rounded-full hover:bg-stone-200 transition-colors">
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div>
 <label className="block text-xs font-bold text-stone-700 uppercase tracking-widest mb-2">Lương cơ bản</label>
 <input type="number" 
 ...
 className="w-full border border-stone-200 rounded-lg px-4 py-2.5 text-sm font-mono font-bold text-stone-800 bg-white focus:outline-none focus:ring-2 focus:ring-orange-600" />
 </div>
 <div>
 <label className="block text-xs font-bold text-stone-700 uppercase tracking-widest mb-2">Phụ cấp</label>
 <input type="number" 
 ...
 <div>
 <label className="block text-xs font-bold text-stone-700 uppercase tracking-widest mb-2">Thưởng (OT, KPI...)</label>
 <input type="number" 
 ...
 className="w-full border border-stone-200 rounded-lg px-4 py-2.5 text-sm font-mono font-bold text-stone-800 bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-emerald-500" />
 </div>
 <div>
 <label className="block text-xs font-bold text-stone-700 uppercase tracking-widest mb-2">Phạt (Đi trễ, vắng...)</label>
 <input type="number" 
 ...
 className="w-full border border-stone-200 rounded-lg px-4 py-2.5 text-sm font-mono font-bold text-stone-800 bg-rose-50 focus:outline-none focus:ring-2 focus:ring-rose-500" />
 </div>
 <div>
 <label className="block text-xs font-bold text-stone-700 uppercase tracking-widest mb-2">Thuế TNCN (-)</label>
 <input type="number" 
 ...
 className="w-full border border-stone-200 rounded-lg px-4 py-2.5 text-sm font-mono font-bold text-stone-800 bg-stone-50 focus:outline-none focus:ring-2 focus:ring-stone-500" />
 </div>
 <div>
 <label className="block text-xs font-bold text-stone-700 uppercase tracking-widest mb-2">Bảo hiểm xã hội (-)</label>
 <input type="number" 
 ...
 <div className="mt-8 p-6 bg-white rounded-xl shadow-inner border border-stone-700 flex justify-between items-center text-[#FAF9F5] relative overflow-hidden">
 <div className="absolute top-0 right-0 w-32 h-32 bg-stone-800/10 rounded-full blur-2xl flex-shrink-0" />
 <div className="absolute bottom-0 left-0 w-24 h-24 bg-emerald-500/10 rounded-full blur-2xl flex-shrink-0" />
 <div className="relative z-10">
 <p className="text-xs font-bold text-stone-300 uppercase tracking-widest mb-1">Thực lãnh (Net Salary)</p>
 <p className="text-sm font-medium text-stone-400">Đã trừ Thuế & BHXH</p>
 </div>
 <div className="relative z-10">
 ...
 <div className="px-6 py-4 border-t border-stone-100 bg-stone-50 flex gap-3 justify-end rounded-b-xl">
 <button 
 onClick={() => {
 ...
 <button onClick={() => { setEditingPayrollId(null); setAiPayrollSuggestion(null); }} className="px-5 py-2.5 text-sm font-bold text-stone-600 bg-white border border-stone-200 rounded-lg hover:bg-stone-100 transition-colors shadow-sm">
 Hủy
 </button>
 <button 
 onClick={() => {
 ...
 className="px-6 py-2.5 text-sm font-bold text-[#FAF9F5] bg-stone-900 rounded-lg hover:bg-stone-800 transition-colors shadow-sm shadow-stone-900/5 flex items-center gap-2">
 ...
 <div 
 key={status} 
 className="bg-stone-100/50 rounded-lg p-4 border border-stone-200"
 onDragOver={handleDragOver}
 onDrop={(e) => handleDrop(e, status)}
 >
 <div className="flex justify-between items-center mb-4">
 <h3 className="font-bold text-stone-700 uppercase tracking-widest text-xs">
 {status === 'sourced' ? 'Sourced' : status === 'interview' ? 'Phỏng vấn' : status === 'offered' ? 'Đề nghị' : 'Đã tuyển'}
 </h3>
 <span className="bg-white px-2 py-0.5 rounded-full text-[10px] font-bold text-stone-500 shadow-sm">
 ...
 className="bg-white p-4 rounded-lg shadow-sm border border-stone-200 cursor-grab active:cursor-grabbing hover:shadow-sm transition-shadow relative overflow-hidden"
 >
 <div className={cn("absolute top-0 left-0 w-1 h-full", 
 candidate.matchScore >= 90 ? "bg-emerald-500" : 
 candidate.matchScore >= 80 ? "bg-stone-800" : "bg-amber-500"
 )} />
 <div className="pl-2">
 <div className="flex justify-between items-start mb-2">
 <p className="font-bold text-sm text-[#111827]">{candidate.name}</p>
 <span className="text-[10px] font-bold text-stone-400 font-mono">{candidate.id}</span>
 </div>
 <p className="text-xs font-medium text-stone-600 mb-3">{candidate.role}</p>
 <div className="flex justify-between items-center">
 ...
 candidate.matchScore >= 80 ? "bg-[#F2F0E9] text-orange-700" : "bg-amber-50 text-amber-600"
 )}>
 ...
 <div className="w-20 h-20 bg-[#F2F0E9] rounded-full flex items-center justify-center mb-6">
 <Rocket className="w-10 h-10 text-orange-600" />
 </div>
 <h3 className="text-xl font-bold text-stone-800 mb-2">Phân hệ đang được phát triển</h3>
 ...
 className="fixed inset-y-0 right-0 w-full max-w-md bg-white shadow-sm z-50 border-l border-stone-200 flex flex-col overflow-y-auto"
 >
 <div className="p-8 border-b border-stone-100 flex justify-between items-start bg-white to-white sticky top-0 z-10">
 <div className="flex gap-4 items-center">
 ...
 <div>
 <h2 className="text-2xl font-bold text-stone-800 tracking-tight leading-tight">{selectedEmployee.fullName}</h2>
 <div className="flex items-center gap-2 mt-1">
 <span className="text-xs font-mono font-bold bg-stone-100 text-stone-500 px-2 py-0.5 rounded uppercase tracking-widest">{selectedEmployee.id}</span>
 <span className="text-sm font-medium text-stone-500">{selectedEmployee.department}</span>
 </div>
 </div>
 </div>
 <button onClick={() => setSelectedEmployee(null)} className="p-2 bg-white border border-stone-200 hover:bg-stone-50 rounded-full transition-colors text-stone-500 shadow-sm active:scale-95">
 ...
 <div className="space-y-6">
 <div className="space-y-4">
 <h3 className="font-bold tracking-widest uppercase text-[11px] text-stone-400 flex items-center gap-2">
 ...
 <div>
 <p className="text-sm font-bold text-stone-800">Cấp quyền hệ thống</p>
 <p className="text-xs text-stone-500 mt-1">Chỉnh sửa vai trò truy cập của nhân viên trên hệ thống ERP.</p>
 </div>
 <select 
 className="bg-white border text-sm font-semibold border-stone-200 text-stone-700 py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-600/20 focus:border-stone-900 shadow-sm transition-all"
 ...
 <h4 className="text-sm font-bold text-stone-800">Phân quyền chi tiết (Permissions)</h4>
 ...
 return (
 <div key={catKey} className="flex items-center justify-between py-2 border-b border-stone-100 last:border-0 last:pb-0">
 <span className="text-xs font-semibold text-stone-600 w-32">{catName}</span>
 <div className="flex gap-4">
 ...
 <input 
 type="checkbox" 
 className="w-3.5 h-3.5 text-orange-700 rounded border-stone-300 focus:ring-orange-600/20 transition-all cursor-pointer"
 ...
 />
 <span className="text-[10px] uppercase font-bold tracking-wider text-stone-500">{label}</span>
 </label>
 );
 })}
 </div>
 ...
 <div className="h-64 bg-stone-50 rounded-xl border border-stone-200 p-4 relative shadow-sm">
 <ResponsiveContainer width="100%" height="100%">
 ...
 <div key={i} className="px-3 py-1.5 bg-[#F2F0E9] text-orange-800 rounded-lg border border-[#EAE7DF] flex items-center justify-between gap-3 text-xs flex-1 min-w-[140px]">
 ...
 {/* Contracts */}
 <div className="space-y-4">
 <h3 className="font-bold tracking-widest uppercase text-xs text-stone-400 flex items-center gap-2">
 ...
 <p className="text-xs font-bold text-stone-800 mb-1">{c.type}</p>
 ...
 <p className="text-xs text-stone-400 italic">Chưa có dữ liệu hợp đồng</p>
 )}
 </div>
 </div>
 ...
 <div className="pl-4 border-l-2 border-stone-100 space-y-6 relative ml-2">
 <div className="relative">
 <div className="absolute -left-[21px] top-1 w-3 h-3 rounded-full bg-stone-800 border-2 border-white shadow-sm" />
 <p className="text-xs font-bold text-stone-800">Cập nhật Lương</p>
 <p className="text-[10px] text-stone-500 font-medium">Tăng 15% lương cơ bản</p>
 <p className="text-[10px] text-stone-400 font-bold uppercase mt-1">11/2023</p>
 </div>
 <div className="relative">
 <div className="absolute -left-[21px] top-1 w-3 h-3 rounded-full bg-emerald-500 border-2 border-white shadow-sm" />
 <p className="text-xs font-bold text-stone-800">Thăng tiến</p>
 <p className="text-[10px] text-stone-500 font-medium">Lên vị trí: {selectedEmployee.position}</p>
 <p className="text-[10px] text-stone-400 font-bold uppercase mt-1">08/2023</p>
 </div>
 <div className="relative">
 <div className="absolute -left-[21px] top-1 w-3 h-3 rounded-full bg-stone-300 border-2 border-white shadow-sm" />
 <p className="text-xs font-bold text-stone-800">Gia nhập công ty</p>
 <p className="text-[10px] text-stone-400 font-bold uppercase mt-1">{selectedEmployee.joinDate}</p>
 </div>
 </div>
 </div>
 ...
 className="w-[380px] h-[500px] bg-white rounded-lg shadow-sm border border-stone-200 overflow-hidden flex flex-col"
 >
 ...
 <p className="text-[10px] text-stone-400 uppercase tracking-widest font-bold">Online</p>
 </div>
 </div>
 <button onClick={() => setIsCopilotOpen(false)} className="text-stone-400 hover:text-[#FAF9F5] transition">
 ...
 msg.role === 'user' ? "bg-stone-900 text-[#FAF9F5] rounded-tr-sm" : "bg-white border border-stone-200 text-stone-700 rounded-tl-sm shadow-sm"
 )}>
 {msg.content}
 </div>
 </div>
 ...
 <div className="flex items-center bg-stone-100 rounded-full pr-1.5 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-orange-600 transition-all">
 <input 
 type="text" 
 value={copilotInput}
 ...
 className="p-2 bg-stone-900 hover:bg-stone-800 text-[#FAF9F5] rounded-full transition-colors shadow-sm"
 >
 ...
 className="w-14 h-14 bg-stone-900 rounded-full shadow-sm text-[#FAF9F5] flex items-center justify-center relative group"
 >
 ...
 <button onClick={() => setShowATSModal(false)} className="p-2 hover:bg-stone-100 rounded-lg text-stone-400"><X className="w-6 h-6" /></button>
 </div>
 ...
 {(['sourced', 'interview', 'offered', 'hired'] as const).map(status => (
 <div key={status} onDragOver={handleDragOver} onDrop={(e) => handleDrop(e, status)} className="bg-stone-50/80 rounded-lg p-5 border border-stone-200 flex flex-col h-[500px]">
 <div className="flex justify-between items-center mb-5">
 <h3 className="font-bold text-stone-700 uppercase tracking-widest text-xs">
 {status === 'sourced' ? 'Sourced' : status === 'interview' ? 'Phỏng vấn' : status === 'offered' ? 'Đề nghị' : 'Đã tuyển'}
 </h3>
 <span className="bg-white px-2.5 py-1 rounded-full text-xs font-bold text-stone-500 shadow-sm border border-stone-100">
 {candidates.filter(c => c.status === status).length}
 </span>
 </div>
 ...
 c.matchScore >= 80 ? "bg-stone-800" : "bg-amber-500"
 )} />
 <div className="pl-3">
 <p className="font-bold text-sm text-stone-800 mb-1 line-clamp-1">{c.name}</p>
 <div className="flex justify-between items-end mt-3">
 <div>
 <span className="text-xs font-semibold text-stone-500 block mb-1">{c.role}</span>
 <span className="text-[10px] font-mono text-stone-400">{c.id}</span>
 </div>
 ...
 c.matchScore >= 80 ? "bg-[#F2F0E9] text-orange-800" : "bg-amber-50 text-amber-700"
 )}>
 Fit {c.matchScore}%
 </div>
 </div>
 ...
 {activeATSView !== 'candidates' && <div className="flex items-center justify-center h-full text-stone-400 text-sm mt-20 font-medium">Nội dung chức năng {activeATSView} đang được xây dựng...</div>}
 </div>
 </motion.div>
 </div>
 )}
