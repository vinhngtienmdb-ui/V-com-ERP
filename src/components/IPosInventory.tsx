          ...
          {[
            ...
            <button
              ...
              className={cn(
                ...
                invTab === t.id ? "bg-primary-600 text-white border-primary-600 shadow-sm shadow-indigo-200" : "bg-white border-slate-300 text-slate-700 hover:text-primary-600 hover:border-primary-200 hover:bg-primary-50"
              )}
            >
        ...
        <div className="bg-white border border-slate-300 rounded-xl shadow-sm p-6 min-h-[400px]">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <div className="flex gap-2">
                ...
                <button className="bg-primary-600 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm shadow-indigo-600/20 hover:bg-primary-700 transition-colors flex items-center gap-2">
           ...
           {invTab === 'kiem' ? (
             ...
             <div className="border border-slate-200 rounded-xl p-6 text-center bg-slate-50/50 shadow-sm">
                ...
                <div className="flex gap-4 justify-center">
                    <button className="px-6 py-3 bg-primary-600 text-white font-bold rounded-lg text-sm shadow-sm hover:bg-primary-700 transition-colors">Tạo Phiếu Nhập</button>
                    <button className="px-6 py-3 bg-white text-primary-700 border border-primary-200 font-bold rounded-lg text-sm shadow-sm hover:bg-primary-50 transition-colors">Xem Phân Tích Dự Báo</button>
                </div>
             </div>
          ) : invTab === 'xuat' ? (
             <div className="border border-slate-200 rounded-xl p-6 text-center bg-slate-50/50 shadow-sm">
                ...
                <div className="flex gap-4 justify-center">
                    <button className="px-6 py-3 bg-orange-600 text-white font-bold rounded-lg text-sm shadow-sm hover:bg-orange-700 transition-colors">Tạo Phiếu Xuất</button>
                    <button className="px-6 py-3 bg-white text-orange-700 border border-orange-200 font-bold rounded-lg text-sm shadow-sm hover:bg-orange-50 transition-colors">Khai Báo Hàng Lỗi</button>
                </div>
             </div>
          ) : invTab === 'goi' ? (
             <div className="border border-slate-200 rounded-xl p-6 text-center bg-slate-50/50 shadow-sm">
                ...
                <div className="flex gap-4 justify-center">
                    <button className="px-6 py-3 bg-teal-600 text-white font-bold rounded-lg text-sm shadow-sm hover:bg-teal-700 transition-colors">Đóng Gói SP</button>
                    <button className="px-6 py-3 bg-white text-teal-700 border border-teal-200 font-bold rounded-lg text-sm shadow-sm hover:bg-teal-50 transition-colors">Bung Gói SP</button>
                </div>
             </div>
          ) : invTab === 'kiemke_thang' ? (
             <div className="border border-slate-200 rounded-xl p-6 text-center bg-slate-50/50 shadow-sm">
                ...
                <button className="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg text-sm shadow-sm hover:bg-blue-700 transition-colors">Mở Dashboard Kế Toán</button>
             </div>
          ) : (
             <div className="mt-8 border border-dashed border-slate-300 rounded-xl p-6 text-center text-slate-500 bg-slate-50/30">
                {FNB_MODE ? (
