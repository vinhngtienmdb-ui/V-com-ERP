    ...
    <div className="col-span-12 flex-1 bg-stone-50 overflow-hidden flex flex-col h-full animate-in fade-in duration-300">
      <div className="bg-white border-b border-stone-200 px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex bg-stone-100 p-1 rounded-lg">
          ...
          <button className="p-2 text-stone-500 hover:text-primary-600 transition-colors"><Search className="w-4 h-4"/></button>
        </div>
      </div>
          ...
          {[
            ...
            <button
              ...
              className={cn(
                ...
                invTab === t.id ? "bg-primary-600 text-white border-primary-600 shadow-md shadow-indigo-200" : "bg-white border-stone-200 text-stone-600 hover:text-primary-600 hover:border-primary-200 hover:bg-primary-50"
              )}
            >
        ...
        <div className="bg-white border border-stone-200 rounded-xl shadow-sm p-6 min-h-[400px]">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <div className="flex gap-2">
                <button className="bg-white border border-stone-200 text-stone-600 px-4 py-2 rounded-lg text-sm font-bold shadow-sm hover:bg-stone-50 hover:border-primary-200 transition-colors flex items-center gap-2">
