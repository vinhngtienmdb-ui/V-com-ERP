        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            <div>
              <h2 className="text-xl font-black text-stone-900 tracking-tight flex items-center gap-2">
                <ShoppingBag className="w-5 h-5 text-indigo-600" /> Quản lý Đơn hàng
              </h2>
            ...
            <div className="flex gap-2">
               <div className="relative">
                  ...
                  <input type="text" placeholder="Tra mã đơn, SĐT khách..." className="pl-9 pr-4 py-2 bg-stone-100 border border-stone-200 rounded-sm text-sm focus:outline-none focus:ring-2 focus:ring-indigo-100 w-64" />
               </div>
