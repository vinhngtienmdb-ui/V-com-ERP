...
export function LoginPage() {
 ...
 {logo ? (
   ...
   <>
     <div className="w-6 h-6 bg-blue-600 rounded-sm transform rotate-45 shadow-sm shadow-slate-900/5"></div>
     <h1 className="font-sans tracking-tight text-xl font-bold text-white tracking-tight">
 ...
 <span className="text-xl font-bold text-slate-900">VComm ERP</span>
 </div>
 <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Chào mừng trở lại</h2>
 <p className="text-slate-500 text-sm font-medium">Nhập thông tin tài khoản được cấp để tiếp tục</p>
 </div>

 <form onSubmit={handleSubmit} className="space-y-6">
 <div className="space-y-1.5">
 <label className="text-[11px] font-bold text-slate-500 uppercase tracking-[0.1em] ml-1">Tên đăng nhập</label>
 ...
 placeholder="admin"
 className="w-full bg-white border border-slate-300 rounded-2xl pl-11 pr-4 py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100 focus:border-[#2563EB] transition-all"
 />
 </div>
 </div>

 <div className="space-y-1.5">
 <label className="text-[11px] font-bold text-slate-500 uppercase tracking-[0.1em] ml-1">Mật khẩu</label>
 <div className="relative group">
 <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-blue-600 transition-colors">
 ...
 className="w-full py-4 bg-blue-600 text-white rounded-lg font-bold text-sm shadow-sm shadow-slate-900/5 hover:bg-slate-800 hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-3 disabled:opacity-50"
 >
 {isSubmitting ? (
