...
const SOCIAL_ACCOUNTS = [
 { id: 'fb', platform: 'Facebook', name: 'VComm Official', status: 'connected', followers: '150k', color: 'bg-slate-900', icon: Share2 },
 ...
 { id: 'x', platform: 'Twitter/X', name: 'vcomm_global', status: 'disconnected', followers: '0', color: 'bg-slate-800', icon: Bird },
];
...
const MARKETING_MODULE_GROUPS = [
 ...
 items: [
 { id: 'omnichannel', label: 'Social Sync', desc: 'Đồng bộ Facebook, TikTok, IG.', icon: Share2, color: 'blue' },
...
export function Marketing() {
 ...
 <h1 className="font-sans tracking-tight text-xl font-bold text-slate-900">Marketing & Omnichannel</h1>
 </div>
 <p className="text-sm text-slate-500">Kết nối đa kênh (FB, TT, IG), Quản lý chiến dịch & Tự động hóa tiếp thị.</p>
 </div>
 ...
 <span className="text-xl font-bold text-slate-900">{formatCurrency(900000000)}</span>
 ...
 <div className="flex items-end justify-between">
 <span className="text-xl font-bold text-slate-900">{formatCurrency(85000000)}</span>
 ...
 <Link2 className="w-5 h-5 text-blue-600" /> Trạng thái Kết nối Tài khoản Social
 </h2>
 ...
 <button className="text-xs font-bold text-blue-600 hover:text-orange-800 flex items-center gap-1">
...
<table className="w-full text-left text-sm">
 ...
 <button className="text-xs font-bold text-slate-600 hover:text-blue-600">Sửa</button>
 </td>
 </tr>
 <tr className="hover:bg-slate-50">
 ...
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-widest text-[10px]">Chiến dịch / Voucher</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-widest text-[10px]">Thời gian chạy</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-widest text-right text-[10px]">Ngân sách / Đã dùng</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-widest text-center text-[10px]">Chỉ số ROAS</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-widest text-[10px]">Trạng thái</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-slate-100">
 ...
 <div className="p-3 rounded-lg bg-slate-100 text-blue-600">
 <Megaphone className="w-5 h-5" />
 </div>
 <div>
 <p className="text-sm font-semibold text-slate-900">{campaign.name}</p>
 <p className="text-[10px] text-slate-500 uppercase tracking-tight">{campaign.type.replace('_', ' ')}</p>
 </div>
 </div>
 </td>
 <td className="px-6 py-4">
 ...
 <p className="text-[10px] text-slate-500">Chi: {formatCurrency(campaign.spent)}</p>
 </td>
 <td className="px-6 py-4">
 ...
 <p className="text-[10px] text-slate-500">Doanh thu: {formatCurrency(campaign.gmvGenerated)}</p>
 </div>
 </td>
 <td className="px-6 py-4">
 <span className={cn(
 ...
 <div className="bg-white rounded-2xl p-6 w-full max-w-lg shadow-sm animate-in zoom-in-95 duration-200">
 <div className="flex justify-between items-center mb-6">
 <div className="flex items-center gap-2 text-blue-600">
 <Megaphone className="w-5 h-5 fill-current" />
 <h2 className="text-lg font-bold text-slate-900">Tạo chiến dịch Marketing</h2>
 </div>
 ...
 <select className="w-full border border-slate-400 rounded-2xl p-2.5 text-sm bg-white outline-none">
 ...
 <button className="w-full bg-blue-600 text-white py-3 rounded-lg font-bold mt-6 hover:bg-slate-800 shadow-sm shadow-slate-900/5 transition-all">
