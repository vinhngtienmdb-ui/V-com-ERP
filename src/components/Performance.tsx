...
export function Performance() {
 ...
 <div className="p-2 bg-[#F2F0E9] text-orange-700 rounded-lg w-fit mb-3">
 ...
 <div className="bg-white text-[#FAF9F5] p-8 rounded-lg flex flex-col items-center text-center space-y-4">
 ...
 <button className="px-8 py-3 bg-[#2563EB] text-[#FAF9F5] font-bold rounded-lg hover:bg-stone-900 transition-all shadow-sm shadow-stone-900/5 flex items-center gap-2">
