...
export function SalesManagement() {
 ...
 <span className="text-[10px] text-orange-700 font-bold bg-slate-100 px-2 py-0.5 rounded">Đúng tiến độ</span>
 </div>
 </div>
 <div className="bg-white p-5 rounded-xl border border-slate-300 shadow-sm hover:shadow-sm transition-all">
 ...
 <span className="text-[10px] text-primary-600 font-bold bg-primary-50 px-2 py-0.5 rounded">Giá trị cao</span>
 </div>
 </div>
 <div className="bg-white p-5 rounded-xl border border-slate-300 shadow-sm hover:shadow-sm transition-all">
 ...
 <span className="text-[10px] text-amber-600 font-bold bg-amber-50 px-2 py-0.5 rounded">Hoa hồng</span>
 </div>
 </div>
 </DraggableGrid>
 ...
 <h3 className="text-lg font-bold uppercase tracking-widest italic">AI Thông minh Bán hàng</h3>
 </div>
 ...
 <div>
 <h4 className="font-bold text-lg italic">Trò chơi hóa Bán hàng</h4>
