...
export function SellerFinance() {
 ...
 <p className="text-sm text-slate-500 mt-1">Chấm điểm tín dụng Seller và cung cấp các giải pháp ứng vốn nhanh, quay vòng vốn linh hoạt.</p>
 </div>
 ...
 <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mb-1">Yêu cầu ứng vốn sớm (Early Payouts)</p>
 ...
 <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mb-1">Doanh thu phí dịch vụ Tài chính</p>
 <div className="text-2xl font-bold text-blue-600">{formatCurrency(450000000)}</div>
 ...
 <div className="bg-white p-6 rounded-2xl border border-slate-300 shadow-sm">
 <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mb-1">Seller AAA (Tín dụng cao)</p>
 ...
 <div className="p-6">
 {activeTab === 'credit' && (
 <div className="overflow-x-auto animate-in fade-in duration-300 min-w-0 custom-scrollbar-x">
 <table className="min-w-[680px] w-full text-left border-collapse">
 <thead>
 <tr className="bg-slate-50 border-b border-slate-100">
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase">Mã Seller / Tên</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase w-36 whitespace-nowrap text-center">Credit Score</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase w-20 whitespace-nowrap">Tier</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase w-36 whitespace-nowrap text-right">Hạn mức (Max)</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase w-32 whitespace-nowrap text-right">Khả dụng</th>
 <th className="px-6 py-4 text-[11px] font-bold text-slate-500 uppercase w-28 whitespace-nowrap">Thao tác</th>
 </tr>
 </thead>
 ...
 <p className="text-sm font-bold text-slate-900">{credit.sellerId}</p>
 <p className="text-[10px] text-slate-500">Hiệu suất tháng: 9.2/10</p>
 </td>
 <td className="px-6 py-4">
 ...
 credit.score > 800 ? "bg-emerald-500" : credit.score > 600 ? "bg-blue-600" : "bg-red-500"
 )} 
 ...
 credit.tier === 'AAA' ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-slate-100 text-blue-600 border border-slate-300"
 )}>{credit.tier}</span>
 </td>
 <td className="px-6 py-4 text-right font-bold text-slate-900">{formatCurrency(credit.maxCreditLimit)}</td>
 <td className="px-6 py-4 text-right font-bold text-blue-600">{formatCurrency(credit.availableCredit)}</td>
 <td className="px-6 py-4">
 <button className="text-[10px] font-bold text-blue-600 bg-slate-100 px-3 py-1.5 rounded-lg hover:bg-[#EAE7DF] transition-colors uppercase tracking-wider">Cấp tín dụng</button>
 </td>
 </tr>
 ))}
 </tbody>
 ...
 <div key={payout.id} className="p-6 bg-white border border-slate-300 rounded-2xl shadow-sm space-y-4 hover:border-[#2563EB] transition-all group">
 ...
 <h4 className="text-xl font-bold text-slate-900 mt-1">{formatCurrency(payout.amount)}</h4>
 ...
 <button className="px-4 py-2 bg-blue-600 text-white text-[10px] font-bold rounded-lg hover:bg-slate-800 transition-all uppercase tracking-widest">Duyệt giải ngân</button>
 </div>
 </div>
 ))}
 </div>
 ...
 <h3 className="text-3xl font-bold font-sans italic tracking-tight">Financial Scoring Engine</h3>
 </div>
 ...
 <div className="w-80 p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 space-y-6 relative overflow-hidden">
