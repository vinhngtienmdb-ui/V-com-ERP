...
export function SellerFinance() {
 ...
 <div className="bg-[#111827] text-[#FAF9F5] p-6 rounded-lg shadow-sm shadow-stone-900/10">
 <div className="flex justify-between items-start mb-4">
 <div className="p-2 bg-stone-800 rounded-lg">
 <BadgeDollarSign className="w-6 h-6" />
 </div>
 <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Tổng dư nợ Seller</span>
 </div>
 ...
 <p className="text-[10px] text-stone-400 mt-1">Đủ điều kiện vay thấu chi 0%</p>
 </div>
 </div>
 ...
 activeTab === tab.id ? "border-[#2563EB] text-[#2563EB] bg-[#F2F0E9]/20" : "border-transparent text-[#6B7280] hover:text-[#111827]"
 )}
 >
 ...
 <tr key={credit.sellerId} className="hover:bg-stone-50 transition-colors">
 ...
 <span className="text-[11px] font-bold text-stone-700">{credit.score}</span>
 </div>
 </td>
 <td className="px-6 py-4">
 <span className={cn(
 "px-3 py-1 rounded-lg text-[10px] font-bold italic tracking-widest",
 credit.tier === 'AAA' ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-[#F2F0E9] text-orange-700 border border-[#EAE7DF]"
 )}>{credit.tier}</span>
 </td>
 ...
 <td className="px-6 py-4">
 <button className="text-[10px] font-bold text-[#2563EB] bg-[#F2F0E9] px-3 py-1.5 rounded-lg hover:bg-[#EAE7DF] transition-colors uppercase tracking-wider">Cấp tín dụng</button>
 </td>
 </tr>
 ))}
 </tbody>
 ...
 <div className="p-2 bg-[#F2F0E9] rounded-lg group-hover:bg-stone-900 transition-colors">
 ...
 <div>
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">{payout.id} • {payout.sellerId}</p>
 ...
 <span className="text-[10px] text-stone-400 font-mono italic">Ngày yêu cầu: {payout.requestDate}</span>
 <button className="px-4 py-2 bg-stone-900 text-[#FAF9F5] text-[10px] font-bold rounded-lg hover:bg-stone-800 transition-all uppercase tracking-widest">Duyệt giải ngân</button>
 </div>
 </div>
 ))}
 </div>
 ...
 <div className="bg-white to-black text-[#FAF9F5] p-10 rounded-lg relative overflow-hidden border border-white/5 shadow-sm">
 <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
 <div className="space-y-6">
 <div className="flex items-center gap-4">
 <div className="p-4 bg-[#2563EB] rounded-lg shadow-sm shadow-stone-900/5">
 ...
 <button className="px-8 py-4 bg-white text-stone-900 font-bold rounded-lg text-sm hover:bg-stone-100 transition-all shadow-sm shadow-white/5">Xem Model Chấm Điểm</button>
 <button className="px-8 py-4 border border-stone-700 text-[#FAF9F5] font-bold rounded-lg text-sm hover:bg-stone-800 transition-all">Lịch sử cấp vốn Seller</button>
 </div>
 </div>
 ...
 <span className="text-stone-300">Quỹ ứng vốn sớm</span>
 ...
 <p className="text-[10px] text-stone-500 font-bold uppercase mb-1">Dự báo nhu cầu 48h tới</p>
