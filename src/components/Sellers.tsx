...
<table className="w-full text-left border-collapse">
 ...
 <p className="text-[12px] font-bold text-emerald-600 mt-1">{formatCurrency(seller.walletBalance || 0)} <span className="text-[10px] font-medium text-slate-600">Ví</span></p>
 ...
 <span className="bg-emerald-100 text-emerald-700 text-[10px] px-2 py-0.5 rounded font-bold">HOẠT ĐỘNG</span>
 </div>
 </div>
