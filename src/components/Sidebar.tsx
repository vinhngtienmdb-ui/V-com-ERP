...
export function Sidebar() {
 ...
 <div className="w-4 h-4 bg-[#2563EB] rounded-sm transform rotate-45 shadow-sm shadow-stone-900/5"></div>
 ...
 isActive 
 ? "bg-[#F2F0E9] text-[#2563EB] font-bold shadow-sm shadow-blue-100/50" 
 : "text-[#4B5563] hover:bg-stone-50 hover:text-[#111827]"
 )}
 >
