                        ...
                        {MOCK_POSTS.map(post => (
                           <div key={post.id} className="bg-white border border-[#F3F4F6] rounded-lg p-6 hover:shadow-md transition-all space-y-4">
                              ...
                              <div className="pt-4 border-t border-[#F3F4F6] flex items-center justify-between">
                                 ...
                                 <button className="bg-[#F9FAFB] px-4 py-2 rounded-lg text-[10px] font-bold text-slate-600 hover:bg-slate-100 transition-all uppercase tracking-widest">Ghim sản phẩm trong bài</button>
                              </div>
                           </div>
                        ))}
                     </div>
         ...
         <div className="space-y-6">
            ...
            <div className="bg-[#111827] text-white p-6 rounded-lg space-y-4 relative overflow-hidden">
               <div className="relative z-10 space-y-4">
                  ...
                  <button className="w-full py-3 bg-blue-600 text-white font-bold rounded-lg text-xs hover:bg-blue-700 transition-all uppercase tracking-widest shadow-lg shadow-blue-500/20">Cấu hình AI Vision</button>
               </div>
