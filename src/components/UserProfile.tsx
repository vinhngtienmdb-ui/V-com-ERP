    ...
    <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Quản lý thông tin cá nhân, bảo mật và tùy chỉnh trải nghiệm của bạn.</p>
        </div>
        <button 
          onClick={handleSave}
          disabled={isSaving}
            ...
            <div className="p-8 space-y-8 animate-in fade-in duration-300">
              <div className="flex flex-col items-center sm:flex-row gap-6">
                <div className="relative group">
                  ...
                  <button className="absolute -bottom-2 -right-2 p-2 bg-white rounded-lg shadow-md border border-slate-100 text-blue-600 hover:scale-110 transition-transform">
                    <Camera className="w-4 h-4" />
                  </button>
                </div>
                <div className="text-center sm:text-left">
                  <h3 className="text-lg font-bold text-slate-900">{staffInfo?.name || 'Nguyễn Văn A'}</h3>
                  <p className="text-sm text-slate-500 font-medium bg-slate-100 px-3 py-1 rounded-full inline-block mt-1 uppercase tracking-wider text-[10px]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-50 border border-slate-100 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium"
                    />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">ID Nhân viên</label>
                  <input 
                    type="text" 
                    readOnly 
                    value={staffInfo?.id || 'STAFF-999'}
                    className="w-full bg-slate-100 border border-slate-100 rounded-xl px-4 py-3 text-sm text-slate-500 font-mono italic"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Email công việc</label>
                  <div className="relative">
              ...
              <div className="pt-6 border-t border-slate-100">
                ...
                <div className="bg-blue-50 p-4 rounded-xl border border-blue-100/50 space-y-3">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-blue-600 font-medium">Ngày bắt đầu:</span>
            ...
            <div className="p-8 space-y-8 animate-in fade-in duration-300">
               <div>
                 ...
                 <div className="grid grid-cols-1 gap-4 max-w-md">
                   <div className="space-y-2">
                     ...
                     <div className="relative">
                       <input 
                         ...
                         className="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                       />
                       <button 
                   ...
                   <button className="bg-slate-900 text-white px-4 py-2.5 rounded-xl text-sm font-bold mt-2 hover:bg-slate-800 transition-all">Cập nhật mật khẩu</button>
                 </div>
               </div>
               ...
               <div className="pt-8 border-t border-slate-100">
                  ...
                  <div className="p-4 bg-slate-50 rounded-lg border border-slate-100 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                       <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-slate-200 px-2 py-1 rounded">Chưa kích hoạt</span>
                 ...
                 {[
                   ...
                   <div key={idx} className="flex items-center justify-between p-4 hover:bg-slate-50 rounded-xl transition-colors">
                      ...
                      <div className={cn(
                        ...
                        <div className={cn(
                          "absolute top-1 w-4 h-4 bg-white rounded-full transition-all outline outline-slate-100",
               ...
               <div className="pt-8 border-t border-slate-100">
                  ...
                  <div className="grid grid-cols-2 gap-4 max-w-sm">
                     <button 
                       ...
                       className={cn("p-3 rounded-xl text-sm font-bold transition-all", language === 'vi' ? "border-2 border-blue-500 bg-white text-blue-600" : "border border-slate-200 bg-white text-slate-500 hover:bg-slate-50")}
                     >
                       Tiếng Việt
                     </button>
                     <button 
                       onClick={() => setLanguage('en')}
                       className={cn("p-3 rounded-xl text-sm font-bold transition-all", language === 'en' ? "border-2 border-blue-500 bg-white text-blue-600" : "border border-slate-200 bg-white text-slate-500 hover:bg-slate-50")}
                     >
                       English
                     </button>
                  </div>
      ...
      <div className="mt-12 bg-rose-50 border border-rose-100 rounded-lg p-6 flex items-center justify-between">
         ...
         <button className="bg-rose-600 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-rose-700 transition-all shadow-lg shadow-rose-200 text-sm">
