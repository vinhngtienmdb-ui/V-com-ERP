...
export function WalletHub() {
 ...
 <h3 className="text-xl font-bold text-slate-900 tracking-tight italic uppercase">
 ...
 <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500 ml-1">Số tiền (VNĐ)</label>
 <input 
 type="number" 
 className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 text-xl font-bold text-slate-900 focus:ring-4 focus:ring-blue-50 focus:border-slate-900 transition-all outline-none"
 placeholder="0"
 ...
 className="flex-[2] py-4 bg-blue-600 text-white rounded-lg font-bold text-xs uppercase tracking-widest shadow-sm shadow-blue-200 hover:bg-slate-800 active:scale-95 transition-all"
 >
 Xác nhận giao dịch
 </button>
 </div>
 ...
 <h1 className="font-sans tracking-tight text-xl font-bold text-slate-900">Ví Tài chính & Ký quỹ (Kho lưu trữ Số)</h1>
 <p className="text-sm text-slate-500 mt-1">Hệ thống thanh toán tập trung, Quản lý dòng tiền và Bảo mật giao dịch Ký quỹ.</p>
 </div>
 ...
 className="bg-white text-blue-600 px-6 py-2.5 rounded-lg font-bold text-sm shadow-sm shadow-blue-900/10 hover:bg-slate-100 transition-all"
 >
 Nạp ví
 </button>
 <button 
 ...
 className="w-full bg-white border border-slate-200 rounded-2xl pl-12 pr-4 py-2.5 text-sm focus:ring-2 focus:ring-orange-600 outline-none"
 />
 </div>
 ...
 className="px-4 py-2 bg-white border border-slate-300 rounded-2xl text-xs font-bold text-slate-700 focus:outline-none focus:border-slate-900"
 />
 <select 
 value={filterType}
 onChange={(e) => setFilterType(e.target.value)}
 className="px-3 py-2 bg-white border border-slate-300 rounded-2xl text-xs font-bold text-slate-700 focus:outline-none focus:border-slate-900"
 >
 ...
 txn.type === 'payout' ? "bg-slate-100 text-blue-600" : "bg-slate-100 text-slate-700"
 )}>
 {txn.type}
 </span>
 </td>
 ...
 <div className="flex gap-2">
 <button className="p-2 bg-slate-50 hover:bg-slate-100 rounded-lg transition-all text-slate-500 hover:text-blue-600">
 ...
 <button className="px-4 py-2 bg-blue-600 text-white text-xs font-bold uppercase rounded-lg shadow-sm shadow-blue-200 hover:bg-slate-800 transition-all flex items-center gap-2">
 ...
 <span className="text-[9px] font-bold uppercase tracking-widest">Live Settlement</span>
 </div>
 <h3 className="text-3xl font-bold italic tracking-tighter uppercase leading-none">Instant Settlement Protocol</h3>
 ...
 <button className="relative z-10 px-8 py-5 bg-white text-blue-600 rounded-lg font-bold text-sm uppercase tracking-widest shadow-sm hover:bg-slate-100 transition-all active:scale-95 whitespace-nowrap">
 ...
 <span className="text-[10px] font-bold uppercase tracking-widest text-orange-500">Security Standard v4.2</span>
 </div>
 <h3 className="text-3xl font-bold italic tracking-tighter uppercase leading-none">Escrow Smart Protocol</h3>
 ...
 <td className="px-6 py-4 text-sm font-bold text-blue-600">{formatCurrency(escrow.amount)}</td>
 <td className="px-6 py-4">
 ...
 <td className="px-6 py-4 text-right text-[10px] font-bold text-slate-500">{escrow.autoReleaseAt}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 {gateways.map(gw => (
 <div key={gw.id} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-sm transition-all relative group overflow-hidden">
 {gw.isPreferred && (
 <div className="absolute top-0 right-0 p-4">
 <div className="px-2 py-1 bg-blue-600 text-white text-[8px] font-bold uppercase rounded-lg shadow-sm">Preferred</div>
 </div>
 )}
 
 <div className="flex gap-4">
 <div className={cn(
 "w-14 h-14 rounded-lg flex items-center justify-center text-white shadow-sm shrink-0",
 ...
 <p className="text-xl font-bold text-slate-900">{gw.transactionFee}%</p>
 </div>
 <div className={cn(
 "px-3 py-1 rounded-full text-[10px] font-bold flex items-center gap-1.5",
 ...
 <button className="text-blue-600 text-[10px] font-bold hover:underline flex items-center gap-1">
 ...
 {/* View Histories */}
 <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 flex flex-col justify-between shadow-sm relative overflow-hidden">
 <div className="absolute top-0 right-0 p-4 opacity-10">
 <History className="w-32 h-32" />
 </div>
 <div className="relative z-10">
 <h3 className="text-xl font-bold text-white italic">Tra cứu Giao dịch</h3>
 ...
 <div className="flex gap-2">
 <input type="text" placeholder="Tìm theo Username, ID..." className="px-4 py-2 border border-slate-200 rounded-2xl text-sm w-64 focus:outline-none focus:ring-2 focus:ring-orange-600" />
 ...
 <button className="w-full py-4 bg-slate-900/5 text-white font-bold rounded-lg hover:bg-slate-900/10 transition-all border border-white/10 text-sm flex items-center justify-center gap-2">
