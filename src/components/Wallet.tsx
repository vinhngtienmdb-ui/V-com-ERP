...
export function WalletHub() {
 ...
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">MÃ£ Giao dá»‹ch</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Loáº¡i giao dá»‹ch</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-right">Sá»‘ tiá»n (VNÄ)</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Gateway</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center">Tráº¡ng thÃ¡i</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Thá»i gian</th>
 </tr>
 </thead>
 ...
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">MÃ£ Ä‘Æ¡n hÃ ng</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Sá»‘ tiá»n KÃ½ quá»¹</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">CÃ¡c bÃªn tham gia</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Status</th>
 <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-right">NgÃ y giáº£i ngÃ¢n</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-slate-50">
 ...
 <th className="px-6 py-4">Äá»‘i tÆ°á»£ng</th>
 <th className="px-6 py-4">Loáº¡i VÃ­</th>
