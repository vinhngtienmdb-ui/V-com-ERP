...
export function WorkflowHub() {
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.2em] text-orange-700 bg-[#F2F0E9] px-2 py-0.5 rounded">Mission Control Hub</span>
 <div className="w-1.5 h-1.5 bg-stone-800 rounded-full animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.6)]" />
 </div>
 <h1 className="font-serif tracking-tight text-3xl font-black text-stone-900 tracking-tight italic">Operations & <span className="text-orange-700 font-serif">Workflows</span></h1>
 <p className="text-sm text-stone-500 font-medium mt-1">Điều phối quy trình ký số, phê duyệt đa cấp và tự động hóa chuỗi cung ứng.</p>
 </div>
 <div className="flex flex-wrap gap-3">
 <button 
 onClick={() => setViewMode(viewMode === 'tasks' ? 'builder' : 'tasks')}
 className="bg-white border border-stone-200 px-5 py-2.5 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-stone-50 transition-all flex items-center gap-2 shadow-sm border-b-2 active:translate-y-0.5"
 >
 ...
 <button className="bg-stone-900 text-[#FAF9F5] px-5 py-2.5 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-stone-800 transition-all shadow-sm shadow-stone-900/10 flex items-center gap-2 hover:scale-[1.02] active:scale-95">
 ...
 <div className={cn(
 "p-4 rounded-none shadow-sm transition-transform group-hover:scale-110 group-hover:rotate-6 duration-500",
 ...
 <div className="bg-white rounded-xl border border-stone-100 shadow-sm overflow-hidden min-h-[600px] flex flex-col">
 ...
 viewMode === 'tasks' ? "bg-white text-orange-700 shadow-sm shadow-stone-900/5 border border-[#EAE7DF]" : "text-stone-500 hover:text-stone-900"
 )}
 >
 ...
 className={cn(
 "px-8 py-4 text-[10px] font-black uppercase tracking-widest transition-all rounded-lg flex items-center gap-2",
 viewMode === 'builder' ? "bg-white text-emerald-600 shadow-sm shadow-emerald-600/10 border border-emerald-100" : "text-stone-500 hover:text-stone-900"
 )}
 >
 ...
 className="bg-stone-50 border border-stone-200 rounded-xl pl-12 pr-6 py-3 text-sm focus:outline-none w-full ring-orange-600/10 focus:ring-4 transition-all"
 />
 </div>
 <div className="flex gap-2">
 <button 
 onClick={() => setFilter('all')}
 className={cn("px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all", filter === 'all' ? "bg-stone-900 text-[#FAF9F5]" : "bg-stone-50 text-stone-500 hover:bg-stone-100")}
 >
 Tất cả
 </button>
 <button 
 onClick={() => setFilter('critical')}
 className={cn("px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all", filter === 'critical' ? "bg-rose-600 text-[#FAF9F5]" : "bg-stone-50 text-stone-500 hover:bg-stone-100")}
 >
 Critical
 </button>
 </div>
 ...
 <div key={task.id} className="p-6 bg-white border border-stone-100 rounded-xl hover:border-orange-200 hover:shadow-sm hover:shadow-stone-900/5 transition-all group flex flex-wrap items-center gap-6 border-b-2">
 <div className={cn(
 "p-4 rounded-lg shadow-sm transition-all group-hover:scale-105",
 ...
 "bg-[#F2F0E9] text-orange-600 shadow-blue-200/30"
 )}>
 ...
 <h4 className="text-base font-black text-stone-900 group-hover:text-orange-700 transition-colors uppercase tracking-tight">{task.title}</h4>
 <p className="text-[11px] text-stone-500 font-bold flex items-center gap-1.5 mt-2 shadow-inner bg-stone-50 px-3 py-1 rounded-full w-fit">
 ...
 <button onClick={() => handleSignRequest(task.id)} className="p-3 bg-[#F2F0E9] text-orange-700 rounded-xl hover:bg-[#EAE7DF] transition-all opacity-0 group-hover:opacity-100 border border-[#EAE7DF]">
 <FileSignature className="w-5 h-5" />
 </button>
 <button onClick={() => navigate(task.link)} className="p-3 bg-stone-900 text-[#FAF9F5] rounded-xl shadow-sm shadow-stone-900/20 hover:scale-110 active:scale-95 transition-all">
 ...
 <div className="bg-stone-950 text-[#FAF9F5] p-10 rounded-xl relative overflow-hidden shadow-sm border border-stone-800 group">
 <div className="relative z-10 space-y-6">
 <div className="p-4 bg-stone-900 rounded-lg shadow-sm shadow-stone-900/5 w-fit group-hover:scale-110 transition-transform">
 ...
 <p className="text-stone-400 text-sm font-medium leading-relaxed">Hệ thống đang tự động lọc 420 task phụ để bạn tập trung vào 8 task quan trọng nhất.</p>
 ...
 <div className="flex justify-between text-[11px] font-black text-stone-700 uppercase tracking-widest">
 <span>{dept.name}</span>
 ...
 <div className="flex-1 bg-stone-50 border border-stone-200 border-dashed rounded-xl relative overflow-hidden flex flex-col p-2">
 ...
 <div className="p-4 bg-white/80 backdrop-blur-md border-t border-stone-200 flex justify-between items-center rounded-b-[3rem]">
 <div className="flex items-center gap-4">
 <div className="w-3 h-3 bg-emerald-500 rounded-full animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.8)]" />
 <span className="text-[10px] font-black uppercase tracking-widest text-stone-500 italic">Neural Canvas Active | Beta v2.4</span>
 </div>
 <div className="flex gap-2">
 <button className="px-5 py-2.5 bg-stone-100 text-stone-900 font-black rounded-xl text-[10px] uppercase tracking-widest hover:bg-stone-200 transition-all">Save Draft</button>
 ...
 className="absolute top-8 right-8 p-3 hover:bg-stone-100 rounded-lg transition-all z-20 group"
 >
 ...
 Cổng Ký Số <span className="text-stone-400 italic font-medium">VComm CA</span>
 </h2>
 </div>
 </div>
 <p className="text-stone-500 font-medium text-base max-w-lg leading-relaxed">
 ...
 ? "bg-stone-950 text-[#FAF9F5] border-stone-900 shadow-sm scale-[1.02]" 
 : "bg-stone-50 border-stone-100 text-stone-900 hover:border-emerald-300 hover:bg-white"
 )}
 >
 <div className={cn(
 "w-10 h-10 rounded-xl mb-4 flex items-center justify-center border transition-colors",
 signatureMethod === ca.id ? "bg-stone-900 border-stone-900" : "bg-white border-stone-200"
 )}>
 ...
 <p className={cn("text-[10px] font-bold mt-1 uppercase tracking-widest opacity-60", signatureMethod === ca.id ? "text-blue-300" : "text-stone-500")}>{ca.desc}</p>
 ...
 <p className="text-xs font-black text-stone-900 uppercase">Audit ID: {signingTaskId}</p>
 <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">TLS 1.3 Encryption Active</p>
 </div>
 </div>
 <button 
 ...
 className={cn(
 "px-10 py-5 font-black rounded-lg text-[10px] uppercase tracking-[0.2em] transition-all shadow-sm flex items-center gap-3 w-full sm:w-auto justify-center active:translate-y-1",
 isSigningInProcess ? "bg-stone-200 text-stone-400 cursor-not-allowed" : "bg-emerald-600 text-[#FAF9F5] shadow-emerald-600/30 hover:bg-emerald-500"
 )}
 >
 {isSigningInProcess ? (
 <>
