...
export function WorkflowHub() {
 ...
 <span className="text-[10px] font-bold uppercase tracking-widest text-blue-600 bg-slate-100 px-2 py-0.5 rounded">Mission Control Hub</span>
 <div className="w-1.5 h-1.5 bg-slate-800 rounded-full animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.6)]" />
 </div>
 <h1 className="font-sans tracking-tight text-xl font-bold text-slate-900 tracking-tight italic">Operations & <span className="text-blue-600 font-sans">Workflows</span></h1>
 ...
 className="bg-white border border-slate-300 px-5 py-2.5 rounded-2xl text-[10px] font-bold uppercase tracking-widest hover:bg-slate-50 transition-all flex items-center gap-2 shadow-sm border-b-2 active:translate-y-0.5"
 >
 ...
 <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-slate-800 transition-all shadow-sm shadow-slate-900/10 flex items-center gap-2 hover:scale-[1.02] active:scale-95">
 ...
 stat.color === 'blue' ? "bg-slate-100 text-blue-600 shadow-blue-100" :
 ...
 className={cn(
 "px-8 py-4 text-[10px] font-bold uppercase tracking-widest transition-all rounded-lg flex items-center gap-2",
 viewMode === 'tasks' ? "bg-white text-blue-600 shadow-sm shadow-slate-900/5 border border-slate-300" : "text-slate-600 hover:text-slate-900"
 )}
 >
 ...
 className={cn("px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all", filter === 'all' ? "bg-blue-600 text-white" : "bg-slate-50 text-slate-600 hover:bg-slate-100")}
 >
 Tất cả
 </button>
 <button 
 onClick={() => setFilter('critical')}
 className={cn("px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all", filter === 'critical' ? "bg-rose-600 text-white" : "bg-slate-50 text-slate-600 hover:bg-slate-100")}
 >
 Critical
 </button>
 </div>
 ...
 "bg-slate-100 text-blue-600 shadow-blue-200/30"
 )}>
 ...
 <span className="text-[10px] font-bold text-blue-600 uppercase tracking-widest">{task.module} • {task.id}</span>
 {task.priority === 'critical' && <div className="w-2 h-2 bg-rose-600 rounded-full animate-pulse" />}
 </div>
 <h4 className="text-base font-bold text-slate-900 group-hover:text-blue-600 transition-colors uppercase tracking-tight">{task.title}</h4>
 ...
 <button onClick={() => handleSignRequest(task.id)} className="p-3 bg-slate-100 text-blue-600 rounded-xl hover:bg-[#EAE7DF] transition-all opacity-0 group-hover:opacity-100 border border-slate-300">
 <FileSignature className="w-5 h-5" />
 </button>
 <button onClick={() => navigate(task.link)} className="p-3 bg-blue-600 text-white rounded-xl shadow-sm shadow-slate-900/20 hover:scale-110 active:scale-95 transition-all">
 ...
 <div className="bg-stone-950 text-white p-10 rounded-xl relative overflow-hidden shadow-sm border border-slate-800 group">
 <div className="relative z-10 space-y-6">
 <div className="p-4 bg-slate-900 rounded-lg shadow-sm shadow-slate-900/5 w-fit group-hover:scale-110 transition-transform">
 <Zap className="w-6 h-6" />
 </div>
 <h3 className="text-2xl font-bold italic tracking-tight">AI Process <br/> <span className="text-orange-500">Accelerator</span></h3>
 ...
 <button className="w-full py-4 bg-white/5 border border-white/10 text-white font-bold rounded-2xl text-[10px] uppercase tracking-widest hover:bg-white/10 transition-all">Audit Automation Log</button>
 </div>
 ...
 <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm shadow-slate-200/40">
 <h4 className="font-bold text-slate-900 uppercase tracking-widest text-xs mb-8 flex items-center gap-3">
 ...
 <div className="flex justify-between text-[11px] font-bold text-slate-800 uppercase tracking-widest">
 <span>{dept.name}</span>
 ...
 <span className="text-[10px] font-bold uppercase tracking-widest text-slate-600 italic">Bảng vẽ đang hoạt động | Beta v2.4</span>
 </div>
 <div className="flex gap-2">
 <button className="px-5 py-2.5 bg-slate-100 text-slate-900 font-bold rounded-xl text-[10px] uppercase tracking-widest hover:bg-slate-200 transition-all">Lưu nháp</button>
 <button className="px-5 py-2.5 bg-emerald-600 text-white font-bold rounded-xl text-[10px] uppercase tracking-widest hover:bg-emerald-700 shadow-sm shadow-emerald-600/20 transition-all">Xuất bản luồng</button>
 </div>
 </div>
 </div>
 )}
 ...
 <div>
 <div className="flex items-center gap-2 mb-1">
 <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-600">Enterprise Digital Identity</span>
 </div>
 ...
 ? "bg-stone-950 text-white border-slate-900 shadow-sm scale-[1.02]" 
 ...
 <h4 className="font-bold text-sm uppercase tracking-tight">{ca.name}</h4>
 <p className={cn("text-[10px] font-bold mt-1 uppercase tracking-widest opacity-60", signatureMethod === ca.id ? "text-blue-600" : "text-slate-600")}>{ca.desc}</p>
 ...
 <p className="text-xs font-bold text-slate-900 uppercase">Audit ID: {signingTaskId}</p>
 ...
 className={cn(
 "px-10 py-5 font-bold rounded-lg text-[10px] uppercase tracking-widest transition-all shadow-sm flex items-center gap-3 w-full sm:w-auto justify-center active:translate-y-1",
 isSigningInProcess ? "bg-slate-100 text-slate-600 cursor-not-allowed" : "bg-emerald-600 text-white shadow-emerald-600/30 hover:bg-emerald-500"
 )}
 >
 {isSigningInProcess ? (
 <>
