...
export function WorkflowHub() {
 ...
 <span className="text-[10px] font-bold uppercase tracking-widest text-slate-600 italic">Neural Canvas Active | Beta v2.4</span>
 </div>
 <div className="flex gap-2">
 <button className="px-5 py-2.5 bg-slate-100 text-slate-900 font-bold rounded-xl text-[10px] uppercase tracking-widest hover:bg-slate-200 transition-all">Save Draft</button>
 <button className="px-5 py-2.5 bg-emerald-600 text-white font-bold rounded-xl text-[10px] uppercase tracking-widest hover:bg-emerald-700 shadow-sm shadow-emerald-600/20 transition-all">Publish Flow</button>
 </div>
 </div>
 </div>
 )}
