...
export function Workspace() {
 ...
 <h1 className="font-sans tracking-tight text-xl font-bold text-slate-900">Không gian làm việc (eOffice)</h1>
 </div>
 <p className="text-sm text-slate-500">Trung tâm điều hành công việc, quy trình và tiện ích nội bộ.</p>
 </div>
 ...
 {/* News / Alert Banner */}
 <div className="bg-slate-900 rounded-lg p-8 text-white relative overflow-hidden shadow-sm shadow-blue-900/10">
 <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
 <div className="flex-1 space-y-4">
 <div className="flex items-center gap-3">
 <div className="bg-slate-800/20 text-orange-500 p-2 rounded-2xl border border-slate-900/30">
 ...
 className="bg-slate-50/50 rounded-2xl border border-slate-300 flex flex-col min-h-[600px]"
 >
 ...
 task.priority === 'Gấp' ? "bg-rose-50 text-rose-600" : "bg-slate-100 text-blue-600"
 )}>
 {task.priority}
 </span>
 ...
 <h4 className="text-sm font-bold text-slate-900 group-hover:text-blue-600 transition-colors mb-2">{task.title}</h4>
